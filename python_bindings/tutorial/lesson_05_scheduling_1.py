...
#
#    python3 path/to/lesson_05_scheduling_1.py
#
# in a shell.
#
...
def main():
    ...
    if True:
        ...
        # out to non-Halide functions like we are, it's your responsibility to
    ...
    if True:
        ...
        # This outermost loop should be a parallel for loop; we'll skip
        # implementing that, in the name of simplicity for this tutorial.
    ...
    if True:
        ...
        x_inner_outer = hl.Var("x_inner_outer")
        ...
        # both in Python and Halide and see if the answers match.
