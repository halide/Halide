...
#ifndef HALIDE_NUMPY_NUMPY_OBJECT_MGR_TRAITS_HPP_INCLUDED
#define HALIDE_NUMPY_NUMPY_OBJECT_MGR_TRAITS_HPP_INCLUDED

/**
 *  @file numpy/numpy_object_mgr_traits.hpp
...
#endif  // !HALIDE_NUMPY_NUMPY_OBJECT_MGR_TRAITS_HPP_INCLUDED
