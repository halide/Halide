...
namespace python {
namespace converter {
NUMPY_OBJECT_MANAGER_TRAITS_IMPL(PyArray_Type, Halide::numpy::ndarray)
...
ndarray ndarray::view(dtype const &dt) const {
    return ndarray(python::detail::new_reference(PyObject_CallMethod(this->ptr(), const_cast<char *>("view"), const_cast<char *>("O"), dt.ptr())));
}

ndarray ndarray::astype(dtype const &dt) const {
    return ndarray(python::detail::new_reference(PyObject_CallMethod(this->ptr(), const_cast<char *>("astype"), const_cast<char *>("O"), dt.ptr())));
}

ndarray ndarray::copy() const {
    return ndarray(python::detail::new_reference(PyObject_CallMethod(this->ptr(), const_cast<char *>("copy"), const_cast<char *>(""))));
}
...
ndarray ndarray::transpose() const {
    return ndarray(python::detail::new_reference(PyArray_Transpose(reinterpret_cast<PyArrayObject *>(this->ptr()), NULL)));
}

ndarray ndarray::squeeze() const {
    return ndarray(python::detail::new_reference(PyArray_Squeeze(reinterpret_cast<PyArrayObject *>(this->ptr()))));
}

ndarray ndarray::reshape(python::tuple const &shape) const {
    return ndarray(python::detail::new_reference(PyArray_Reshape(reinterpret_cast<PyArrayObject *>(this->ptr()), shape.ptr())));
}
...
ndarray zeros(python::tuple const &shape, dtype const &dt) {
    ...
    return ndarray(python::detail::new_reference(PyArray_Zeros(nd, dims.get(), detail::incref_dtype(dt), 0)));
}

ndarray zeros(int nd, Py_intptr_t const *shape, dtype const &dt) {
    return ndarray(python::detail::new_reference(PyArray_Zeros(nd, const_cast<Py_intptr_t *>(shape), detail::incref_dtype(dt), 0)));
}
...
ndarray empty(python::tuple const &shape, dtype const &dt) {
    ...
    for (int n = 0; n < nd; ++n)
        dims[n] = python::extract<Py_intptr_t>(shape[n]);
    return ndarray(python::detail::new_reference(PyArray_Empty(nd, dims.get(), detail::incref_dtype(dt), 0)));
}

ndarray empty(int nd, Py_intptr_t const *shape, dtype const &dt) {
    return ndarray(python::detail::new_reference(PyArray_Empty(nd, const_cast<Py_intptr_t *>(shape), detail::incref_dtype(dt), 0)));
}
...
ndarray from_object(python::object const &obj, dtype const &dt, int nd_min, int nd_max, ndarray::bitflag flags) {
    ...
    return ndarray(python::detail::new_reference(PyArray_FromAny(obj.ptr(),
