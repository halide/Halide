...
#ifndef HALIDE_NUMPY_INVOKE_MATCHING_HPP_INCLUDED
#define HALIDE_NUMPY_INVOKE_MATCHING_HPP_INCLUDED

/**
 *  @file numpy/invoke_matching.hpp
...
#endif // !HALIDE_NUMPY_INVOKE_MATCHING_HPP_INCLUDED
