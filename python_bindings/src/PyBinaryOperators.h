...
#define BINARY_OP(op, method)                                                                                                                    \
    .def(                                                                                                                                        \
        "__" #method "__", [](const self_t &self, const other_t &other) -> decltype(self op other) { return self op other; }, py::is_operator()) \
        .def(                                                                                                                                    \
            "__r" #method "__", [](const self_t &self, const other_t &other) -> decltype(self op other) { return other op self; }, py::is_operator())
