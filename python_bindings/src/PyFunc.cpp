...
void define_func(py::module &m) {
    ...
    auto func_class = py::class_<Func>(m, "Func")
                          ...
                          .def(
                              "realize", [](Func &f, Buffer<> buffer, const Target &target, const ParamMap &param_map) -> void {
                          ...
                          .def(
                              "realize", [](Func &f, std::vector<Buffer<>> buffers, const Target &t, const ParamMap &param_map) -> void {
                                  f.realize(Realization(buffers), t);
                              },
                              py::arg("dst"), py::arg("target") = Target(), py::arg("param_map") = ParamMap())

                          .def(
                              "realize", [](Func &f, std::vector<int32_t> sizes, const Target &target, const ParamMap &param_map) -> py::object {
                          ...
                          .def(
                              "realize", [](Func &f, int x_size, const Target &target, const ParamMap &param_map) -> py::object {
                          ...
                          // TODO: deprecate in favor of std::vector<int32_t> size version?
                          .def(
                              "realize", [](Func &f, int x_size, int y_size, const Target &target, const ParamMap &param_map) -> py::object {
                          ...
                          // TODO: deprecate in favor of std::vector<int32_t> size version?
                          .def(
                              "realize", [](Func &f, int x_size, int y_size, int z_size, const Target &target, const ParamMap &param_map) -> py::object {
                          ...
                          // TODO: deprecate in favor of std::vector<int32_t> size version?
                          .def(
                              "realize", [](Func &f, int x_size, int y_size, int z_size, int w_size, const Target &target, const ParamMap &param_map) -> py::object {
