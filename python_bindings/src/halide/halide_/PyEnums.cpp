...
void define_enums(py::module &m) {
    ...
    py::enum_<Target::Feature>(m, "TargetFeature")
        ...
        .value("VulkanInt8", Target::Feature::VulkanInt8)
        .value("VulkanInt16", Target::Feature::VulkanInt16)
        .value("VulkanInt64", Target::Feature::VulkanInt64)
        .value("VulkanFloat16", Target::Feature::VulkanFloat16)
        .value("VulkanFloat64", Target::Feature::VulkanFloat64)
        .value("VulkanV10", Target::Feature::VulkanV10)
        .value("VulkanV12", Target::Feature::VulkanV12)
        .value("VulkanV13", Target::Feature::VulkanV13)
