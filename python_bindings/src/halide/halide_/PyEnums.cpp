...
void define_enums(py::module &m) {
    ...
    py::enum_<Target::Feature>(m, "TargetFeature")
        ...
        .value("D3D12Compute_HLSL_60", Target::Feature::D3D12Compute_HLSL_60)
        .value("D3D12Compute_HLSL_61", Target::Feature::D3D12Compute_HLSL_61)
        .value("D3D12Compute_HLSL_62", Target::Feature::D3D12Compute_HLSL_62)
        .value("D3D12Compute_HLSL_63", Target::Feature::D3D12Compute_HLSL_63)
        .value("D3D12Compute_HLSL_64", Target::Feature::D3D12Compute_HLSL_64)
        .value("D3D12Compute_HLSL_65", Target::Feature::D3D12Compute_HLSL_65)
        .value("D3D12Compute_HLSL_66", Target::Feature::D3D12Compute_HLSL_66)
        .value("D3D12Compute_HLSL_67", Target::Feature::D3D12Compute_HLSL_67)
        .value("D3D12Compute_HLSL_68", Target::Feature::D3D12Compute_HLSL_68)
        .value("D3D12Compute_HLSL_69", Target::Feature::D3D12Compute_HLSL_69)
