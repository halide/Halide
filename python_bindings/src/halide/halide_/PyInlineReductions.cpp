...
void define_inline_reductions(py::module &m) {
    m.def("sum", static_cast<Expr (*)(Expr, const std::string &s)>(&Halide::sum),
          py::arg("expr"), py::arg("name") = "sum");
    m.def("sum", static_cast<Expr (*)(const RDom &, Expr, const std::string &s)>(&Halide::sum),
          py::arg("rdom"), py::arg("expr"), py::arg("name") = "sum");

    m.def("product", static_cast<Expr (*)(Expr, const std::string &s)>(&Halide::product),
          py::arg("expr"), py::arg("name") = "product");
    m.def("product", static_cast<Expr (*)(const RDom &, Expr, const std::string &s)>(&Halide::product),
          py::arg("rdom"), py::arg("expr"), py::arg("name") = "product");

    m.def("maximum", static_cast<Expr (*)(Expr, const std::string &s)>(&Halide::maximum),
          py::arg("expr"), py::arg("name") = "maximum");
    m.def("maximum", static_cast<Expr (*)(const RDom &, Expr, const std::string &s)>(&Halide::maximum),
          py::arg("rdom"), py::arg("expr"), py::arg("name") = "maximum");

    m.def("minimum", static_cast<Expr (*)(Expr, const std::string &s)>(&Halide::minimum),
          py::arg("expr"), py::arg("name") = "minimum");
    m.def("minimum", static_cast<Expr (*)(const RDom &, Expr, const std::string &s)>(&Halide::minimum),
