...
void defineVar()
{
    ...
    auto var_class = p::class_<Var>("Var",
            ...
            .def("implicit", &Var::implicit, p::arg("n"),
                 ...
                 "('_') appears.").staticmethod("implicit")
            ...
            .def("gpu_blocks", &Var::gpu_blocks, // no args
                 "Vars to use for scheduling producer/consumer pairs on the gpu.").staticmethod("gpu_blocks")
            .def("gpu_threads", &Var::gpu_threads, // no args
                 "Vars to use for scheduling producer/consumer pairs on the gpu.").staticmethod("gpu_threads")
