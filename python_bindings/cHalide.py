...
def bounds_of_expr(*args):
  return _cHalide.bounds_of_expr(*args)
bounds_of_expr = _cHalide.bounds_of_expr
...
class CodeGen(IRVisitor):
    __swig_setmethods__ = {}
    for _s in [IRVisitor]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, CodeGen, name, value)
    __swig_getmethods__ = {}
    for _s in [IRVisitor]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, CodeGen, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_setmethods__["ref_count"] = _cHalide.CodeGen_ref_count_set
    __swig_getmethods__["ref_count"] = _cHalide.CodeGen_ref_count_get
    if _newclass:ref_count = _swig_property(_cHalide.CodeGen_ref_count_get, _cHalide.CodeGen_ref_count_set)
    __swig_destroy__ = _cHalide.delete_CodeGen
    __del__ = lambda self : None;
    def compile(self, *args): return _cHalide.CodeGen_compile(self, *args)
    def compile_to_bitcode(self, *args): return _cHalide.CodeGen_compile_to_bitcode(self, *args)
    def compile_to_native(self, *args): return _cHalide.CodeGen_compile_to_native(self, *args)
    def compile_to_function_pointers(self): return _cHalide.CodeGen_compile_to_function_pointers(self)
    def mcpu(self): return _cHalide.CodeGen_mcpu(self)
    def mattrs(self): return _cHalide.CodeGen_mattrs(self)
    def use_soft_float_abi(self): return _cHalide.CodeGen_use_soft_float_abi(self)
    def jit_init(self, *args): return _cHalide.CodeGen_jit_init(self, *args)
    def jit_finalize(self, *args): return _cHalide.CodeGen_jit_finalize(self, *args)
CodeGen_swigregister = _cHalide.CodeGen_swigregister
CodeGen_swigregister(CodeGen)

class CodeGen_Posix(CodeGen):
    __swig_setmethods__ = {}
    for _s in [CodeGen]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, CodeGen_Posix, name, value)
    __swig_getmethods__ = {}
    for _s in [CodeGen]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, CodeGen_Posix, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _cHalide.delete_CodeGen_Posix
    __del__ = lambda self : None;
CodeGen_Posix_swigregister = _cHalide.CodeGen_Posix_swigregister
CodeGen_Posix_swigregister(CodeGen_Posix)

X86_64Bit = _cHalide.X86_64Bit
X86_SSE41 = _cHalide.X86_SSE41
X86_AVX = _cHalide.X86_AVX
X86_NaCl = _cHalide.X86_NaCl
class CodeGen_X86(CodeGen_Posix):
    __swig_setmethods__ = {}
    for _s in [CodeGen_Posix]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, CodeGen_X86, name, value)
    __swig_getmethods__ = {}
    for _s in [CodeGen_Posix]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, CodeGen_X86, name)
    __repr__ = _swig_repr
    def __init__(self, options=0): 
        this = _cHalide.new_CodeGen_X86(options)
        try: self.this.append(this)
        except: self.this = this
    def compile(self, *args): return _cHalide.CodeGen_X86_compile(self, *args)
    __swig_getmethods__["test"] = lambda x: _cHalide.CodeGen_X86_test
    if _newclass:test = staticmethod(_cHalide.CodeGen_X86_test)
    __swig_destroy__ = _cHalide.delete_CodeGen_X86
    __del__ = lambda self : None;
CodeGen_X86_swigregister = _cHalide.CodeGen_X86_swigregister
CodeGen_X86_swigregister(CodeGen_X86)

def CodeGen_X86_test():
  return _cHalide.CodeGen_X86_test()
CodeGen_X86_test = _cHalide.CodeGen_X86_test
...
class CodeGen_GPU_Dev(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, CodeGen_GPU_Dev, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, CodeGen_GPU_Dev, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _cHalide.delete_CodeGen_GPU_Dev
    __del__ = lambda self : None;
    def compile(self, *args): return _cHalide.CodeGen_GPU_Dev_compile(self, *args)
    def init_module(self): return _cHalide.CodeGen_GPU_Dev_init_module(self)
    def compile_to_src(self): return _cHalide.CodeGen_GPU_Dev_compile_to_src(self)
    def get_current_kernel_name(self): return _cHalide.CodeGen_GPU_Dev_get_current_kernel_name(self)
    def dump(self): return _cHalide.CodeGen_GPU_Dev_dump(self)
    __swig_getmethods__["is_gpu_var"] = lambda x: _cHalide.CodeGen_GPU_Dev_is_gpu_var
    if _newclass:is_gpu_var = staticmethod(_cHalide.CodeGen_GPU_Dev_is_gpu_var)
CodeGen_GPU_Dev_swigregister = _cHalide.CodeGen_GPU_Dev_swigregister
CodeGen_GPU_Dev_swigregister(CodeGen_GPU_Dev)

def CodeGen_GPU_Dev_is_gpu_var(*args):
  return _cHalide.CodeGen_GPU_Dev_is_gpu_var(*args)
CodeGen_GPU_Dev_is_gpu_var = _cHalide.CodeGen_GPU_Dev_is_gpu_var

GPU_PTX = _cHalide.GPU_PTX
GPU_OpenCL = _cHalide.GPU_OpenCL
GPU_OpenGL = _cHalide.GPU_OpenGL
class CodeGen_GPU_Host(CodeGen_X86):
    __swig_setmethods__ = {}
    for _s in [CodeGen_X86]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, CodeGen_GPU_Host, name, value)
    __swig_getmethods__ = {}
    for _s in [CodeGen_X86]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class CodeGen_PTX_Dev(CodeGen,CodeGen_GPU_Dev):
    __swig_setmethods__ = {}
    for _s in [CodeGen,CodeGen_GPU_Dev]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, CodeGen_PTX_Dev, name, value)
    __swig_getmethods__ = {}
    for _s in [CodeGen,CodeGen_GPU_Dev]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, CodeGen_PTX_Dev, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _cHalide.new_CodeGen_PTX_Dev()
        try: self.this.append(this)
        except: self.this = this
    def compile(self, *args): return _cHalide.CodeGen_PTX_Dev_compile(self, *args)
    def init_module(self): return _cHalide.CodeGen_PTX_Dev_init_module(self)
    __swig_getmethods__["test"] = lambda x: _cHalide.CodeGen_PTX_Dev_test
    if _newclass:test = staticmethod(_cHalide.CodeGen_PTX_Dev_test)
    def compile_to_src(self): return _cHalide.CodeGen_PTX_Dev_compile_to_src(self)
    def get_current_kernel_name(self): return _cHalide.CodeGen_PTX_Dev_get_current_kernel_name(self)
    def dump(self): return _cHalide.CodeGen_PTX_Dev_dump(self)
    __swig_destroy__ = _cHalide.delete_CodeGen_PTX_Dev
    __del__ = lambda self : None;
CodeGen_PTX_Dev_swigregister = _cHalide.CodeGen_PTX_Dev_swigregister
CodeGen_PTX_Dev_swigregister(CodeGen_PTX_Dev)

def CodeGen_PTX_Dev_test():
  return _cHalide.CodeGen_PTX_Dev_test()
CodeGen_PTX_Dev_test = _cHalide.CodeGen_PTX_Dev_test

class CodeGen_OpenCL_Dev(CodeGen_GPU_Dev):
    __swig_setmethods__ = {}
    for _s in [CodeGen_GPU_Dev]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, CodeGen_OpenCL_Dev, name, value)
    __swig_getmethods__ = {}
    for _s in [CodeGen_GPU_Dev]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, CodeGen_OpenCL_Dev, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _cHalide.new_CodeGen_OpenCL_Dev()
        try: self.this.append(this)
        except: self.this = this
    def compile(self, *args): return _cHalide.CodeGen_OpenCL_Dev_compile(self, *args)
    def init_module(self): return _cHalide.CodeGen_OpenCL_Dev_init_module(self)
    def compile_to_src(self): return _cHalide.CodeGen_OpenCL_Dev_compile_to_src(self)
    def get_current_kernel_name(self): return _cHalide.CodeGen_OpenCL_Dev_get_current_kernel_name(self)
    def dump(self): return _cHalide.CodeGen_OpenCL_Dev_dump(self)
    __swig_destroy__ = _cHalide.delete_CodeGen_OpenCL_Dev
    __del__ = lambda self : None;
CodeGen_OpenCL_Dev_swigregister = _cHalide.CodeGen_OpenCL_Dev_swigregister
CodeGen_OpenCL_Dev_swigregister(CodeGen_OpenCL_Dev)
...
class CodeGen_ARM(CodeGen_Posix):
    __swig_setmethods__ = {}
    for _s in [CodeGen_Posix]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, CodeGen_ARM, name, value)
    __swig_getmethods__ = {}
    for _s in [CodeGen_Posix]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, CodeGen_ARM, name)
    __repr__ = _swig_repr
    def __init__(self, options=0): 
        this = _cHalide.new_CodeGen_ARM(options)
        try: self.this.append(this)
        except: self.this = this
    def compile(self, *args): return _cHalide.CodeGen_ARM_compile(self, *args)
    __swig_getmethods__["test"] = lambda x: _cHalide.CodeGen_ARM_test
    if _newclass:test = staticmethod(_cHalide.CodeGen_ARM_test)
    __swig_destroy__ = _cHalide.delete_CodeGen_ARM
    __del__ = lambda self : None;
CodeGen_ARM_swigregister = _cHalide.CodeGen_ARM_swigregister
CodeGen_ARM_swigregister(CodeGen_ARM)

def CodeGen_ARM_test():
  return _cHalide.CodeGen_ARM_test()
CodeGen_ARM_test = _cHalide.CodeGen_ARM_test
