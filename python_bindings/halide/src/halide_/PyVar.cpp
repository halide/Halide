...
void define_var(py::module &m) {
    auto var_class =
        py::class_<Var>(m, "Var")
            ...
            .def("is_implicit", static_cast<bool (Var::*)() const>(&Var::is_implicit))
            .def("implicit_index", static_cast<int (Var::*)() const>(&Var::implicit_index))
            .def("is_placeholder", static_cast<bool (Var::*)() const>(&Var::is_placeholder))
            .def_static("implicit", &Var::implicit)
