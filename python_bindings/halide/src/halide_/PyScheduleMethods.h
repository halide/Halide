...
HALIDE_NEVER_INLINE void add_schedule_methods(PythonClass &class_instance) {
    ...
    class_instance
        ...
        .def("split_aligned", (T & (T::*)(const VarOrRVar &, const VarOrRVar &, const VarOrRVar &, const Expr &, const Expr &, TailStrategy)) & T::split_aligned,
        ...
        .def("sme_streaming", &T::sme_streaming, py::arg("x") = Var::outermost())

        .def("host", &T::host, py::arg("x") = Var::outermost())
