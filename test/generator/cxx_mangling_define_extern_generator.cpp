...
public:
    ...
    void generate() {
        ...
        args.emplace_back(Halide::user_context_value());
        args.push_back(input);
        args.emplace_back(cast<int8_t>(1));
        args.emplace_back(cast<uint8_t>(2));
        args.emplace_back(cast<int16_t>(3));
        args.emplace_back(cast<uint16_t>(4));
        args.emplace_back(cast<int32_t>(5));
        args.emplace_back(cast<uint32_t>(6));
        args.emplace_back(cast<int64_t>(7));
        args.emplace_back(cast<uint64_t>(8));
        args.emplace_back(cast<bool>(9 == 9));
        args.emplace_back(cast<float>(10.0f));
        args.emplace_back(cast<double>(10.0f));
