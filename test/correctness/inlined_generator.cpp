...
constexpr float kRuntimeFactor = 2.f;
constexpr int kRuntimeOffset = 32;
}  // namespace

TEST(InlinedGeneratorTest, DirectApply) {
...
TEST(InlinedGeneratorTest, CreateWithGeneratorParams) {
    GeneratorContext context(get_jit_target_from_environment());
