...
void check_hvx_all() {
    ...
    check("v*.uh = vadd(v*.ub,v*.ub)", hvx_width/1, u16(u8_1) + u16(u8_2));
    check("v*.uw = vadd(v*.uh,v*.uh)", hvx_width/2, u32(u16_1) + u32(u16_2));
    ...
    check("v*.uh = vsub(v*.ub,v*.ub)", hvx_width/1, u16(u8_1) - u16(u8_2));
    check("v*.uw = vsub(v*.uh,v*.uh)", hvx_width/2, u32(u16_1) - u32(u16_2));
