...
int main(int argc, char **argv) {
    ...
    int result_f = evaluate_can_gpu<int>(arg_max_f());
    ...
    evaluate_can_gpu(arg_max_g(), &best_x, &best_y, &best_val);
    ...
    evaluate_can_gpu(argmax(g(r.x, r.y)), &best_x, &best_y, &best_val);
    ...
    evaluate_can_gpu(argmin(g(r.x, r.y)), &best_x, &best_y, &best_val);
