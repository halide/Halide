...
int main(int argc, char **argv) {
...

    {
        ...
        check(i16(-32768) >> i16(14),  i16(-2));
        check(i16(32767)  >> i16(-14), i16(-16384));
        check(i16(-32768) << i16(14),  i16(0));
        check(i16(32767)  << i16(-14), i16(1));
        ...
        check(u16(65535) >> u16(15), u16(1));
        check(u16(0)     << u16(15), u16(0));
        check(u16(65535) << u16(15), u16(32768));

        check(u16(0)     >> u16(16), u16(0));
        check(u16(65535) >> u16(16), u16(0));
        check(u16(0)     << u16(16), u16(0));
        check(u16(65535) << u16(16), u16(0));
