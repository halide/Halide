...
int main(int argc, char **argv) {
    ...
    f.compute_root().specialize(gpu_f).gpu_tile(x, x, tx, 16);
    g.compute_root().specialize(gpu_g).gpu_tile(x, x, tx, 16);
    h.compute_root().specialize(gpu_h).gpu_tile(x, x, tx, 16);
