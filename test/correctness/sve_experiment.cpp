...
int main(int argc, char *argv[]) {
    ...
    {
    Target t("riscv-64-linux-rvv-no_runtime-no_asserts-no_bounds_query-disable_llvm_loop_opt-vector_bits_512");
    int vectorize_amount = t.natural_vector_size<uint8_t>();
    ...
    result.compile_to_assembly("/tmp/rvv_experiment.s", { in_a, in_b }, "vec_add_1d", t);
    }
