...
int main() {
    ...
    gradient_fast.compile_to(Outputs().stmt_html(result_file_1), {});
    ...
    gradient_fast.compile_to(Outputs().stmt_html(result_file_2), {im});
    ...
    tuple_func.compile_to(Outputs().stmt_html(result_file_3), {});
