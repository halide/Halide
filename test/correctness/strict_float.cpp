...
void run_all_conditions(const char *name, Buffer<float> &vals) {
    ...
    Target loose{get_jit_target_from_environment().without_feature(Target::ForceStrictFloat).with_feature(Target::AllowStrictFloat)};
    Target strict{loose.with_feature(Target::ForceStrictFloat)};
