...
TEST(ReductionPredicateRacingTest, OutOfRange) {
    Var x;
    Func f;
    ...
    ASSERT_NO_THROW(f.realize({20}));
}

TEST(ReductionPredicateRacingTest, NoCommunication) {
    Var x;
    Func f;
...
TEST(ReductionPredicateRacingTest, DisjointParity) {
    Var x;
    Func f;
