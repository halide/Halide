...
TEST(LotsOfDimensions, Basic) {
    ...
    ASSERT_EQ(count, (int)in.number_of_elements());

    // Write Halide code that squares it and subtracts 3
    ImageParam input(UInt(64), 8);
    Func f, g, h;
    Var v0, v1, v2, v3, v4, v5, v6, v7;
    f(v0, v1, v2, v3, v4, v5, v6, v7) =
        pow(input(v0, v1, v2, v3, v4, v5, v6, v7), 2);
    g(v0, v1, v2, v3, v4, v5, v6, v7) =
        f(v0, v1, v2, v3, v4, v5, v6, v7) - 2;
    h(_) = g(_) - 1;
