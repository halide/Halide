...
class DebugToFileTest : public ::testing::TestWithParam<std::string> {};
TEST_P(DebugToFileTest, SaveAndReload) {
...
INSTANTIATE_TEST_SUITE_P(Formats, DebugToFileTest,
                         ::testing::Values("npy", "mat"));
