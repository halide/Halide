...
int calling_in_in_wrapper_no_op_test() {
    Var x("x"), y("y");
...
int multiple_funcs_sharing_in_wrapper_test() {
...
int update_defined_after_in_in_wrapper_test() {
    Func source("source"), g("g");
    Var x("x"), y("y");
...
int global_and_custom_in_in_wrapper_test() {
    Func source("source"), g("g"), result("result");
    Var x("x"), y("y");
...
int wrapper_on_in_wrapper_test() {
...
int multi_folds_in_wrapper_test() {
...
int main(int argc, char **argv) {
    ...
    if (calling_in_in_wrapper_no_op_test() != 0) {
        return -1;
    }

    printf("Running func wrap test\n");
    if (func_in_in_wrapper_test() != 0) {
        return -1;
    }

    printf("Running multiple funcs sharing wrapper test\n");
    if (multiple_funcs_sharing_in_wrapper_test() != 0) {
        return -1;
    }

    printf("Running global wrap test\n");
    if (global_in_in_wrapper_test() != 0) {
        return -1;
    }

    printf("Running update is defined after wrap test\n");
    if (update_defined_after_in_in_wrapper_test() != 0) {
        return -1;
    }

    printf("Running rdom wrapper test\n");
    if (rdom_in_wrapper_test() != 0) {
        return -1;
    }

    printf("Running global + custom wrapper test\n");
    if (global_and_custom_in_in_wrapper_test() != 0) {
        return -1;
    }
    ...
    if (wrapper_on_in_wrapper_test() != 0) {
        return -1;
    }
    ...
    if (two_fold_in_wrapper_test() != 0) {
        return -1;
    }

    printf("Running multi folds wrapper test\n");
    if (multi_folds_in_wrapper_test() != 0) {
        return -1;
    }
