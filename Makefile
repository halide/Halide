...
FUZZ_TESTS = $(filter-out %fuzz_stdlib_main.cpp, $(shell ls $(ROOT_DIR)/test/fuzz/*.cpp))
...
$(BIN_DIR)/fuzz_%: $(ROOT_DIR)/test/fuzz/%.cpp $(ROOT_DIR)/test/fuzz/fuzz_stdlib_main.cpp $(ROOT_DIR)/test/fuzz/fuzz_helpers.h $(ROOT_DIR)/test/fuzz/fuzz_stdlib_main.h $(TEST_DEPS)
