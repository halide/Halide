...
$(BUILD_DIR)/Simplify_%.o: $(SRC_DIR)/Simplify_%.cpp $(SRC_DIR)/Simplify_Internal.h $(SRC_DIR)/Simplify_Helper_Internal.h $(SRC_DIR)/Simplify_%_Helper.h $(BUILD_DIR)/llvm_ok
	@mkdir -p $(@D)
