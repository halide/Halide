...
test_apps: distrib
	...
	@make -C apps/conv_layer clean  HALIDE_DISTRIB_DIR=$(CURDIR)/$(DISTRIB_DIR)
	@make -C apps/conv_layer test   HALIDE_DISTRIB_DIR=$(CURDIR)/$(DISTRIB_DIR)
	...
	@make -C apps/blur clean       HALIDE_DISTRIB_DIR=$(CURDIR)/$(DISTRIB_DIR)
	@make -C apps/blur test        HALIDE_DISTRIB_DIR=$(CURDIR)/$(DISTRIB_DIR)
	@make -C apps/wavelet clean    HALIDE_DISTRIB_DIR=$(CURDIR)/$(DISTRIB_DIR)
	@make -C apps/wavelet test     HALIDE_DISTRIB_DIR=$(CURDIR)/$(DISTRIB_DIR)
	@make -C apps/c_backend clean  HALIDE_DISTRIB_DIR=$(CURDIR)/$(DISTRIB_DIR)
	@make -C apps/c_backend test   HALIDE_DISTRIB_DIR=$(CURDIR)/$(DISTRIB_DIR)
	...
	# linear_blur doesn't currently have a Makefile
