...
You must set an environment variable named `HL_WEBGPU_NODE_BINDINGS` that has an
...
header from the `webgpu-native` GitHub organization that will be compatible with
