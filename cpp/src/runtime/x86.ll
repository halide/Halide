...
define weak_odr <16 x i8> @abs_i8x16(<16 x i8> %x) nounwind uwtable readnone optsize inlinehint alwaysinline {
...
define weak_odr <8 x i16> @abs_i16x8(<8 x i16> %x) nounwind uwtable readnone optsize inlinehint alwaysinline {
...
define weak_odr <4 x i32> @abs_i32x4(<4 x i32> %x) nounwind uwtable readnone optsize inlinehint alwaysinline {
...
define weak_odr <4 x float> @sqrt_f32x4(<4 x float> %x) nounwind uwtable readnone optsize inlinehint alwaysinline {
...
define weak_odr <2 x double> @sqrt_f64x2(<2 x double> %x) nounwind uwtable readnone optsize inlinehint alwaysinline {
