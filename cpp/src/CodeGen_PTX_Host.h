...
protected:
    ...
    /** Construct an initial JITCompiledModule for JITing. Overloads the
     * default process to additionally link in CUDA runtime symbols, as
     * needed. */
    JITCompiledModule jit_init();
