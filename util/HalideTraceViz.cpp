...
Funcs.
 ...
 --uninit_default r g b : Specifies the default on-screen color
   corresponding to uninitialized memory, and is different from
   --uninit somehow, TODO.  Defaults to black.
 ...
 --auto_layout: Enables automatic layout of funcs.  The funcs will be
     ...
     trace file.  Use --auto_layout_grid to set the grid dimensions.
 ...
 --ignore_tags: some command line parsing thing.  TODO.
 --no-ignore_tags: some command line parsing thing.  TODO.
