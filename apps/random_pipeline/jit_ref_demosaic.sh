...
SAMPLES_DIR=/mnt/ilcompf8d1/user/kcma/jit_ref_demosaic/
rm -rf ${SAMPLES_DIR}
mkdir -p ${SAMPLES_DIR}
...
g++ -w -std=c++11  -I ../../distrib/include/ -I ../../distrib/tools/ -I ./ -g -Wall jit_ref_demosaic.cpp ../../distrib/lib/libHalide.a -o ${DIR}/gen_demosaic_pipes -ldl -lpthread -lz -ltinfo -fopenmp && \
