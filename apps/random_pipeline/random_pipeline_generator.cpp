...
public:
    ...
    Stage padding(Stage f) {
        ...
        return {BoundaryConditions::constant_exterior(f.func, zero, {{0, f.w}, {0, f.h}, {0, f.c}}),
            f.w, f.h, f.c};
    }
    ...
    void generate() {
        ...
        if (auto_schedule) {
            ...
            */
            ...
            uint8_weights.set_estimates({{0, 512}, {-5, 5}, {-5, 5}, {0, 512}});
            uint16_weights.set_estimates({{0, 512},
               {-5, 5},
               {-5, 5},
               {0, 512}});
            uint32_weights.set_estimates({{0, 512},
               {-5, 5},
               {-5, 5},
               {0, 512}});
            int8_weights.set_estimates({{0, 512},
               {-5, 5},
               {-5, 5},
               {0, 512}});
            int16_weights.set_estimates({{0, 512},
               {-5, 5},
               {-5, 5},
               {0, 512}});
            int32_weights.set_estimates({{0, 512},
               {-5, 5},
               {-5, 5},
               {0, 512}});
            float32_weights.set_estimates({{0, 512},
               {-5, 5},
               {-5, 5},
               {0, 512}});
