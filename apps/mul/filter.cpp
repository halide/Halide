...
int main(int argc, char **argv) {
    ...
    mul_llvm(input0, 2, input1, 5, 5, 10000, 1, 5, 225, output_llvm);
    ...
    mul_halide(input0, 2, input1, 5, 5, 10000, 1, 5, 225, output_halide);
    ...
    mul_pitchfork(input0, 2, input1, 5, 5, 10000, 1, 5, 225, output_pitchfork);
    ...
    mul_rake(input0, 2, input1, 5, 5, 10000, 1, 5, 225, output_rake);
