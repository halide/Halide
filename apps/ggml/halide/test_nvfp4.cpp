// Standalone round-trip check: the from-scratch Halide NVFP4 dequantize
...
int main() {
    ...
    ggml_quants_halide_dequantize_nvfp4(ref_blocks.data(), halide_y.data(), k);
