// Standalone round-trip check: the from-scratch Halide Q5_0 kernels vs
...
int main() {
    ...
    ggml_quants_halide_dequantize_q5_0(halide_blocks.data(), halide_y.data(), k);
