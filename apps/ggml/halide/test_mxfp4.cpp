// Standalone round-trip check: the from-scratch Halide MXFP4 dequantize
...
int main() {
    ...
    ggml_quants_halide_dequantize_mxfp4(ref_blocks.data(), halide_y.data(), k);
