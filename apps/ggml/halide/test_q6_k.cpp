// Standalone round-trip check: the from-scratch Halide Q6_K dequantize
...
int main() {
    ...
    const ggml_type_traits *tt = ggml_get_type_traits(GGML_TYPE_Q6_K);
    ...
    ggml_quants_halide_quantize_q6_k(x.data(), halide_blocks.data(), k);
    ...
    ggml_quants_halide_dequantize_q6_k(ref_blocks.data(), halide_y.data(), k);
