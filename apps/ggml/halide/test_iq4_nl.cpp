// Standalone round-trip check: the from-scratch Halide IQ4_NL dequantize
...
int main() {
    ...
    ggml_quants_halide_dequantize_iq4_nl(ref_blocks.data(), halide_y.data(), k);
