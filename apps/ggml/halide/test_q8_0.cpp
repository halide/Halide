// Standalone round-trip check: the from-scratch Halide Q8_0 kernels vs
...
int main() {
    ...
    ggml_quants_halide_dequantize_q8_0(halide_blocks.data(), halide_y.data(), k);
