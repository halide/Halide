...
int main(int argc, char **argv) {
    ...
    bench_c2c.compile_to(Outputs().stmt_html("c2c.html"), bench_c2c.infer_arguments());
    ...
    bench_r2c.compile_to(Outputs().stmt_html("r2c.html"), bench_r2c.infer_arguments());
    ...
    bench_c2r.compile_to(Outputs().stmt_html("c2r.html"), bench_c2r.infer_arguments());
