...
| flash_attention | 65536 queries x 1024 keys, depth 64, fp16, chunk 64 (two-pass RDom form: chunk 32), RTX 5060 Ti | 0.396 | 0.549 | 0.384 | FlashAttention-2 (torch SDPA) | 1.39x | 0.97x |
