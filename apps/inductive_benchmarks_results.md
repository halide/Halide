...
| cuda_mamba2 | fwd, seq 4096, state 128, 128 heads x 64, chunk 256 (Triton 256), RTX 5060 Ti | 1.6 | 1.7 | 1.6 | Triton (mamba_ssm) | 1.08x | 0.99x |
...
| flash_attention | 65536 queries x 1024 keys, depth 64, fp16, chunk 64, RTX 5060 Ti | 0.394 | 0.819 | 0.384 | FlashAttention-2 (torch SDPA) | 2.08x | 0.97x |
