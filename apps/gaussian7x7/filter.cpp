...
int main(int argc, char **argv) {
    ...
    gaussian7x7_llvm(input, output_llvm);
    ...
    gaussian7x7_halide(input, output_halide);
    ...
    gaussian7x7_pitchfork(input, output_pitchfork);
    ...
    gaussian7x7_rake(input, output_rake);
