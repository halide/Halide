...
int main(int argc, char **argv) {
    ...
    l2norm_llvm(input, 0, output_llvm);
    ...
    l2norm_halide(input, 0, output_halide);
    ...
    l2norm_pitchfork(input, 0, output_pitchfork);
    ...
    l2norm_rake(input, 0, output_rake);
