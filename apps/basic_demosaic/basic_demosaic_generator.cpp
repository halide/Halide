    ...
    void generate() {
        ...
        if (!auto_schedule) {
            ...
            green_pred.f.compute_at(green.f, xi)
                ...
                .unroll(x)
                .unroll(y);
            g_final_weights.f.compute_at(green.f, xi)
                .unroll(x)
                .unroll(y);
            ...
            g_conv1x1_2.f.compute_at(g_conv1x1_2.f.in(), c)
                .unroll(c)
                .unroll(x)
                .unroll(y)
                .update()
                .reorder(c, x, y, g_conv1x1_2.r[0])
                .unroll(c)
                .unroll(x)
                .unroll(y);

            g_conv1x1_1.f.in()  // Should be a relu
                .compute_at(g_conv1x1_2.f.in(), xi)
                .reorder(x, y, c, n)
                .unroll(x)
                .unroll(y)
                .gpu_lanes(c);

            g_conv1x1_1.f.compute_at(g_conv1x1_1.f.in(), c)
                .unroll(c)
                .unroll(x)
                .unroll(y)
                .update()
                .reorder(c, x, y, g_conv1x1_1.r[0])
                .unroll(c)
                .unroll(x)
                .unroll(y);

            g_conv2d.f.in()  // Should be a relu
                .compute_at(g_conv1x1_2.f.in(), xi)
                .reorder(x, y, c, n)
                .unroll(x)
                .unroll(y)
            ...
            g_conv2d.f.compute_at(g_conv2d.f.in(), c)
                .unroll(c)
                .unroll(x)
                .unroll(y)
                .update()
                .reorder(c, x, y, g_conv2d.r[0], g_conv2d.r[1], g_conv2d.r[2])
                .unroll(c)
                .unroll(x)
                .unroll(y);

            g_conv2d.padded.compute_at(g_conv1x1_2.f.in(), x)
            ...
            g_interpolations.f.compute_at(g_interpolations.f.in(), c)
                .unroll(c)
                .unroll(x)
                .unroll(y)
                .update()
                .reorder(c, x, y, g_interpolations.r[0], g_interpolations.r[1], g_interpolations.r[2])
                .unroll(c)
                .unroll(x)
                .unroll(y);

            g_interpolations.padded.compute_at(g_interpolations.f.in(), x)
                .split(Halide::_2, y, yi, 3)
                .gpu_threads(y)
                .unroll(yi)
                .gpu_lanes(Halide::_1)
