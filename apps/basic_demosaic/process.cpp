...
#include "basic_demosaic.h"
  ...
  #include "basic_demosaic_auto_schedule_sioutas.h"
  #include "basic_demosaic_auto_schedule_sioutas_folded.h"
#endif
...
int main(int argc, char **argv) {
    ...
    #ifndef NO_AUTO_SCHEDULE
        {"basic_demosaic Sioutas Auto-scheduled", [&]() { basic_demosaic_auto_schedule_sioutas(input, g_conv2d_weights, g_1x1_1_weights, g_1x1_2_weights, g_filter_weights, chroma_v_weights, chroma_q_weights, chroma_h_weights, output); output.device_sync(); }},
