...
int main(int argc, char **argv) {
    ...
    _assert(inverse_haar_x(transformed, inverse_transformed) == 0,
            "inverse_haar_x failed");
    ...
    _assert(inverse_daubechies_x(transformed, inverse_transformed) == 0,
            "inverse_daubechies_x failed");
    save_untransformed(inverse_transformed,
                       dirname + "/inverse_daubechies_x.png");
