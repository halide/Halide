...
export ANDROID_ARM64_TOOLCHAIN=/local/mnt/workspace/dev/sdk/2.0/Hexagon_SDK/2.0/tools/android-ndk-r10d/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64
...
#make clean run-arm-64-android CXX=clang++ LDFLAGS="-L/pkg/qct/software/llvm/build_tools/libedit_tw/lib -L ../../bin -Wl,--start-group -lHalide  -lpthread -ldl -Wl,--end-group" # LIB_HALIDE=../../bin/libHalide.so  
