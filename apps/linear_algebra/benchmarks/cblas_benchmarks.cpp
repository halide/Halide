...
struct BenchmarksFloat : public BenchmarksBase<float> {
    ...
    L1Benchmark(copy, "s", cblas_scopy(N, &(x[0]), 1, &(y[0]), 1))
        L1Benchmark(scal, "s", cblas_sscal(N, alpha, &(x[0]), 1)) L1Benchmark(
            axpy, "s", cblas_saxpy(N, alpha, &(x[0]), 1, &(y[0]), 1))
                ...
                L1Benchmark(asum, "s", result = cblas_sasum(N, &(x[0]), 1))
                    ...
                    L2Benchmark(gemv_notrans, "s",
                                cblas_sgemv(CblasColMajor, CblasNoTrans, N, N,
                                            alpha, &(A[0]), N, &(x[0]), 1, beta,
                                            &(y[0]), 1))

                        L2Benchmark(gemv_trans, "s",
                                    cblas_sgemv(CblasColMajor, CblasTrans, N, N,
                                                alpha, &(A[0]), N, &(x[0]), 1,
                                                beta, &(y[0]), 1))

                            L2Benchmark(ger, "s",
                                        cblas_sger(CblasColMajor, N, N,
                                                   alpha, &(x[0]), 1, &(y[0]),
                                                   1, &(A[0]), N))
...
struct BenchmarksDouble : public BenchmarksBase<double> {
    ...
    L1Benchmark(copy, "d", cblas_dcopy(N, &(x[0]), 1, &(y[0]), 1))
        L1Benchmark(scal, "d", cblas_dscal(N, alpha, &(x[0]), 1)) L1Benchmark(
            axpy, "d", cblas_daxpy(N, alpha, &(x[0]), 1, &(y[0]), 1))
