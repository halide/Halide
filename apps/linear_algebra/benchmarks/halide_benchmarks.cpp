...
struct BenchmarksFloat : public BenchmarksBase<float> {
    BenchmarksFloat(std::string n)
        : BenchmarksBase(n), result(1) {
    }

    Halide::Runtime::Buffer<float> result;

    L1Benchmark(copy, "s", halide_scopy(x.raw_buffer(), y.raw_buffer()))
        L1Benchmark(scal, "s", halide_sscal(alpha, x.raw_buffer())) L1Benchmark(
            axpy, "s", halide_saxpy(alpha, x.raw_buffer(), y.raw_buffer()))
            L1Benchmark(dot, "s", halide_sdot(x.raw_buffer(), y.raw_buffer(),
                                              result.raw_buffer()))
                L1Benchmark(asum, "s",
                            halide_sasum(x.raw_buffer(), result.raw_buffer()))

                    L2Benchmark(gemv_notrans, "s",
                                halide_sgemv(false, alpha, A.raw_buffer(),
                                             x.raw_buffer(), beta,
                                             y.raw_buffer()))

                        L2Benchmark(gemv_trans, "s",
                                    halide_sgemv(true, alpha, A.raw_buffer(),
                                                 x.raw_buffer(), beta,
                                                 y.raw_buffer()))

                            L2Benchmark(ger, "s",
                                        halide_sger(alpha, x.raw_buffer(),
                                                    y.raw_buffer(),
                                                    A.raw_buffer()))

                                L3Benchmark(gemm_notrans, "s",
                                            halide_sgemm(false, false, alpha,
                                                         A.raw_buffer(),
                                                         B.raw_buffer(), beta,
                                                         C.raw_buffer()))

                                    L3Benchmark(gemm_transA, "s",
                                                halide_sgemm(true, false, alpha,
                                                             A.raw_buffer(),
                                                             B.raw_buffer(), beta,
                                                             C.raw_buffer()))

                                        L3Benchmark(gemm_transB, "s",
                                                    halide_sgemm(false, true,
                                                                 alpha,
                                                                 A.raw_buffer(),
                                                                 B.raw_buffer(),
                                                                 beta,
...
struct BenchmarksDouble : public BenchmarksBase<double> {
    ...
    L1Benchmark(copy, "d", halide_dcopy(x.raw_buffer(), y.raw_buffer()))
        L1Benchmark(scal, "d", halide_dscal(alpha, x.raw_buffer())) L1Benchmark(
            axpy, "d", halide_daxpy(alpha, x.raw_buffer(), y.raw_buffer()))
            L1Benchmark(dot, "d", halide_ddot(x.raw_buffer(), y.raw_buffer(),
                                              result.raw_buffer()))
                L1Benchmark(asum, "d",
                            halide_dasum(x.raw_buffer(), result.raw_buffer()))

                    L2Benchmark(gemv_notrans, "d",
                                halide_dgemv(false, alpha, A.raw_buffer(),
                                             x.raw_buffer(), beta,
                                             y.raw_buffer()))

                        L2Benchmark(gemv_trans, "d",
                                    halide_dgemv(true, alpha, A.raw_buffer(),
                                                 x.raw_buffer(), beta,
                                                 y.raw_buffer()))

                            L2Benchmark(ger, "d",
                                        halide_dger(alpha, x.raw_buffer(),
                                                    y.raw_buffer(),
                                                    A.raw_buffer()))

                                L3Benchmark(gemm_notrans, "d",
                                            halide_dgemm(false, false, alpha,
                                                         A.raw_buffer(),
                                                         B.raw_buffer(), beta,
                                                         C.raw_buffer()))

                                    L3Benchmark(gemm_transA, "d",
                                                halide_dgemm(true, false, alpha,
                                                             A.raw_buffer(),
                                                             B.raw_buffer(), beta,
                                                             C.raw_buffer()))

                                        L3Benchmark(gemm_transB, "d",
                                                    halide_dgemm(false, true,
                                                                 alpha,
                                                                 A.raw_buffer(),
                                                                 B.raw_buffer(),
                                                                 beta,
