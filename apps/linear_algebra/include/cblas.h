/**
 * Original at http://www.netlib.org/blas/cblas.h. Processed by clang-format.
 *
 * The reference BLAS is a freely-available software package. It is available
 * from netlib via anonymous ftp and the World Wide Web. Thus, it can be included
 * in commercial software packages (and has been). We only ask that proper credit
