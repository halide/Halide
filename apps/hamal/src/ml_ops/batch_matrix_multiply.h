#ifndef HALIDE_APPS_HAMAL_BATCH_MATRIX_MULTIPLY_H_
#define HALIDE_APPS_HAMAL_BATCH_MATRIX_MULTIPLY_H_
...
struct BatchMatrixMultiply : public Halide::NamesInterface {
    ...
    void float32_layer(Func in1, Func in2, Expr shared_dim_size,
        ...
        assert(in1_args.size() == in2_args.size());
        assert(in1_args.size() > 2);
...
#endif  // HALIDE_APPS_HAMAL_BATCH_MATRIX_MULTIPLY_H_
