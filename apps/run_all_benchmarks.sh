BENCHMARKS="bilateral_grid local_laplacian nl_means lens_blur camera_pipe stencil_chain unsharp harris interpolate_generator max_filter hist conv_layer iir_blur_generator bgu resnet_50_blockwise mat_mul_generator"
