...
int main(int argc, char **argv) {
    ...
    gaussian5x5_llvm(input, output_llvm);
    ...
    gaussian5x5_halide(input, output_halide);
    ...
    gaussian5x5_pitchfork(input, output_pitchfork);
    ...
    gaussian5x5_rake(input, output_rake);
