...
#include "median3x3_llvm.h"
#include "median3x3_halide.h"
#include "median3x3_pitchfork.h"
#include "median3x3_rake.h"
...
int main(int argc, char **argv) {
    ...
    median3x3_llvm(input, output_llvm);
    ...
    median3x3_halide(input, output_halide);
    ...
    median3x3_pitchfork(input, output_pitchfork);
    ...
    median3x3_rake(input, output_rake);
