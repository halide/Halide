...
-l gPyramid[1] "differently-curved intermediate pyramids" 680 32 \
...
-l outGPyramid[5] "output pyramid" 1500 32 \
...
-l local_laplacian "output" 1700 32 |\
