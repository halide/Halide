...
int main(int argc, char **argv) {
    ...
    sobel3x3_llvm(input, output_llvm);
    ...
    sobel3x3_halide(input, output_halide);
    ...
    sobel3x3_pitchfork(input, output_pitchfork);
    ...
    sobel3x3_rake(input, output_rake);
