...
int main(int argc, char **argv) {
    ...
    output.raw_buffer()->dim[1].stride = width * 4;

    output.raw_buffer()->dim[2].extent = 4;
    output.raw_buffer()->dim[2].stride = 1;
