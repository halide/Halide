...
#define SCHEDULE_FUNCTION_RW(schedule)                  _SCHEDULE_PAIR(p010_linear, rw, schedule)

#ifdef SCHEDULE_ALL
#define SCHEDULE_FUNCTION_RO(schedule)                  _SCHEDULE_PAIR(p010_linear, ro, schedule)
#else
