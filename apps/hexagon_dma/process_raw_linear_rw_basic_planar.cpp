...
int main(int argc, char **argv) {
    ...
    if (!strcmp(str,"basic")) {
        ...
        ret = pipeline_raw_linear_rw_basic_planar(input, output);
    } else if (!strcmp(str,"fold")) {
        printf("Fold pipeline\n");
        ret = pipeline_raw_linear_rw_fold_planar(input, output);
    } else if (!strcmp(str,"async")) {
        printf("Async pipeline\n");
        ret = pipeline_raw_linear_rw_async_planar(input, output);
    } else if (!strcmp(str,"split")) {
        printf("Split pipeline\n");
        ret = pipeline_raw_linear_rw_split_planar(input, output);
    } else if (!strcmp(str,"split_fold")) {
        printf("Split Fold pipeline\n");
        ret = pipeline_raw_linear_rw_split_fold_planar(input, output);
    } else {
