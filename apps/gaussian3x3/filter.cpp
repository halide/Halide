...
int main(int argc, char **argv) {
    ...
    gaussian3x3_llvm(input, output_llvm);
    ...
    gaussian3x3_halide(input, output_halide);
    ...
    gaussian3x3_pitchfork(input, output_pitchfork);
    ...
    gaussian3x3_rake(input, output_rake);
