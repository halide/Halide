...
-f local_laplacian_fixed 0 65535 2 0 1 4   1700 100 1 0 0 1 0 0 \
-l local_laplacian_fixed "output" 1700 32 10 |\
avconv -f rawvideo -pix_fmt bgr32 -s 1920x1080 -i /dev/stdin -c:v h264 ./bin/local_laplacian_fixed.mp4
