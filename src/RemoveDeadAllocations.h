...
/** Find Allocate/Free pairs that are never loaded from or stored to, and remove them from the Stmt. This
 *  doesn't touch Realize/Call nodes and so must be called after storage_flattening.
 */
