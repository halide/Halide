...
void CodeGen_LLVM::optimize_module() {
    ...
    b.LoopVectorize = false; // TODO(abadams): !get_target().has_feature(Target::DisableLLVMLoopVectorize);
    b.DisableUnrollLoops = true; // TODO(abadams): get_target().has_feature(Target::DisableLLVMLoopUnroll);
