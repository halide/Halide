...
#define HALIDE_BUFFER_FORWARD_INITIALIZER_LIST(method, ...)      \
    ...
    HALIDE_BUFFER_FORWARD(cropped)
    HALIDE_BUFFER_FORWARD_INITIALIZER_LIST(cropped, std::vector<std::pair<int, int>>)
    ...
    HALIDE_BUFFER_FORWARD(translated)
    HALIDE_BUFFER_FORWARD_INITIALIZER_LIST(translated, std::vector<int>)
