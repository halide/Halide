...
/// @param external_params Optional map of named external parameters (used to avoid deserializing specific objects and enable the use of externally defined ones instead).
