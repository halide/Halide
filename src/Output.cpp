...
void compile_halide_module_to_object(const Module &module, std::string filename) {
    if (filename.empty()) filename = module.name() + ".o";

    llvm::LLVMContext context;
    llvm::Module *llvm = compile_halide_module_to_llvm_module(module, context);
    compile_llvm_module_to_object(llvm, filename);
    delete llvm;
}

void compile_halide_module_to_assembly(const Module &module, std::string filename)  {
...
void compile_halide_module_to_native(const Module &module,
...
void compile_halide_module_to_bitcode(const Module &module, std::string filename)  {
    if (filename.empty()) filename = module.name() + ".bc";

    llvm::LLVMContext context;
    llvm::Module *llvm = compile_halide_module_to_llvm_module(module, context);
    compile_llvm_module_to_bitcode(llvm, filename);
    delete llvm;
}

void compile_halide_module_to_llvm_assembly(const Module &module, std::string filename)  {
...
void compile_halide_module_to_llvm(const Module &module,
    ...
    llvm::LLVMContext context;
    llvm::Module *llvm = compile_halide_module_to_llvm_module(module, context);
    compile_llvm_module_to_bitcode(llvm, bitcode_filename);
    compile_llvm_module_to_llvm_assembly(llvm, llvm_assembly_filename);
    delete llvm;
}

void compile_halide_module_to_html(const Module &module, std::string filename) {
    if (filename.empty()) filename = module.name() + ".html";

    Internal::print_to_html(filename, module);
}

void compile_halide_module_to_text(const Module &module, std::string filename) {
...
void compile_halide_module_to_c_header(const Module &module, std::string filename) {
...
void compile_halide_module_to_c_source(const Module &module, std::string filename) {
...
void compile_halide_module_to_c(const Module &module,
              std::string h_filename,
              std::string c_filename) {
    compile_halide_module_to_c_header(module, h_filename);
    compile_halide_module_to_c_source(module, c_filename);
}
