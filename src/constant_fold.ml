    ...
    | Bop (op, a, b) ->
      begin match (op, recurse a, recurse b) with
        ...
        *)
        ...
        | (Add, Bop (Mul, y1, x1), Bop (Mul, y2, x2)) 
        | (Add, Bop (Mul, x1, y1), Bop (Mul, y2, x2)) 
        | (Add, Bop (Mul, y1, x1), Bop (Mul, x2, y2)) 
        | (Add, Bop (Mul, x1, y1), Bop (Mul, x2, y2)) when y1 = y2 ->
          recurse ((x1 +~ x2) *~ y1)
            (* 
        | (Sub, Bop (Mul, y1, x1), Bop (Mul, y2, x2)) 
        | (Sub, Bop (Mul, x1, y1), Bop (Mul, y2, x2)) 
        | (Sub, Bop (Mul, y1, x1), Bop (Mul, x2, y2)) 
            *)
