...
HALIDE_EXPORT Func lambda(const Expr &e);
...
HALIDE_EXPORT Func lambda(const Var &x, const Expr &e);
 ...
 * arguments contains a placeholder ("_"). */
HALIDE_EXPORT Func lambda(const Var &x, const Var &y, const Expr &e);
 ...
 * arguments contains a placeholder ("_"). */
HALIDE_EXPORT Func lambda(const Var &x, const Var &y, const Var &z, const Expr &e);

/** Create a 4-D halide function in the first four arguments that
 * returns the last argument. The function may have more dimensions if
 * the expression contains implicit arguments and the list of Var
 * arguments contains a placeholder ("_"). */
HALIDE_EXPORT Func lambda(const Var &x, const Var &y, const Var &z, const Var &w, const Expr &e);

/** Create a 5-D halide function in the first five arguments that
 * returns the last argument. The function may have more dimensions if
 * the expression contains implicit arguments and the list of Var
 * arguments contains a placeholder ("_"). */
HALIDE_EXPORT Func lambda(const Var &x, const Var &y, const Var &z, const Var &w, const Var &v, const Expr &e);
