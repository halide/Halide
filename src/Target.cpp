...
const std::vector<FeatureRule> &feature_rules() {
    static const std::vector rules = {
        ...
        requires_arch(Target::SME2, Target::ARM),
        requires_arch(Target::SME_SVL128, Target::ARM),
        requires_arch(Target::SME_SVL256, Target::ARM),
        requires_arch(Target::SME_SVL512, Target::ARM),
        requires_arch(Target::SME_SVL1024, Target::ARM),
        requires_arch(Target::SME_SVL2048, Target::ARM),
        ...
        implies(Target::SME2, Target::ARMDotProd),
        implies(Target::SME2, Target::ARMFp16),
