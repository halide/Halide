...
public:
    ...
    EXPORT Parameter(Type t, bool is_buffer, int dimensions,
                     ...
                     bool register_instance = true, bool is_removed_before_lowering = false);
    ...
    /** Return true iff this Parameter is expected to be simplified
     * away at the start of lowering, and thus should not be used to
     * infer arguments */
    EXPORT bool is_removed_before_lowering() const;
