...
public:
     ...
     * buffer parameter, otherwise, it is a scalar parameter. If the
     * third argument is true, the the name being passed in was explicitly specified
     * (as opposed to autogenerated). */
    EXPORT Parameter(Type t, bool is_buffer, const std::string &name, bool is_explicit_name = false);
