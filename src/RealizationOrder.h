 ...
 */
HALIDE_EXPORT_FOR_PLUGINS std::pair<std::vector<std::string>, std::vector<std::vector<std::string>>> realization_order(
...
HALIDE_EXPORT_FOR_PLUGINS std::vector<std::string> topological_order(
