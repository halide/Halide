...
EXPORT void compile_llvm_module_to_shared_object(llvm::Module &module, const std::string &filename);
EXPORT void compile_llvm_module_to_shared_object(llvm::Module &module, std::vector<uint8_t> &object);
