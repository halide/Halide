            ...
            (rewrite(max(max(x, c0), c1), max(x, fold(max(c0, c1)))) ||
             ...
             (no_overflow(op->type) &&
              (rewrite(max(max(x, y) + c0, x), max(x, y + c0), c0 < 0) ||
               ...
               rewrite(max((x/c0)*c1, (x/c2)*c3), (x/c0)*c1, ((c0*c1) < 0) && ((c1*c2) <= (c3*c0))) ||
               rewrite(max((x/c0)*c1, (x/c2)*c3), (x/c2)*c3, ((c0*c1) < 0) && ((c1*c2) >= (c3*c0))) ||
               rewrite(max((x/c0)*c1, (x/c2)*c3), (x/c2)*c3, ((c0*c1) >= 0) && ((c1*c2) <= (c3*c0))) ||
               rewrite(max((x/c0)*c1, (x/c2)*c3), (x/c0)*c1, ((c0*c1) >= 0) && ((c1*c2) >= (c3*c0))) ||
               rewrite(max(x/c0, (x/c1)*c2), x/c0, (c0 < 0) && (c1 <= (c2*c0))) ||
               rewrite(max(x/c0, (x/c1)*c2), (x/c1)*c2, (c0 < 0) && (c1 >= (c2*c0))) ||
               rewrite(max(x/c0, (x/c1)*c2), (x/c1)*c2, (c0 >= 0) && (c1 <= (c2*c0))) ||
               rewrite(max(x/c0, (x/c1)*c2), x/c0, (c0 >= 0) && (c1 >= (c2*c0))) ||
