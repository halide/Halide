...
Expr Simplify::visit(const Max *op, ExprInfo *bounds) {
 ...
 rewrite(max(min(x, (y + c0)), (min(y, c1) + c0)), min(max(x, (c0 + c1)), (y + c0))) ||
 ...
 rewrite(max(min(y, (x + c0)), (min(x, (y + c1)) + c2)), (min((x + c0), y) + max(max((c2 - c0), (c1 + c2)), 0)), (((((c0 + c1) <= 0) || ((c1 + c2) <= 1)) || ((((c1*2) + c0) + c2) <= 2)) && (((0 <= (c0 + c1)) || (c2 <= c0)) && ((min(c0, c2) + c1) <= 0)))) ||
 rewrite(max(min(y, (x + c0)), (min((y + c1), x) + c2)), min((x + c0), y), ((c2 <= c0) && ((c1 + c2) <= 0))) ||
 rewrite(max(min(y, (x + c0)), (min((y + c1), x) + c2)), (min((x + c0), y) + max(max((c2 - c0), (c1 + c2)), 0)), (((((c0 + c1) <= 0) || ((c1 + c2) <= 1)) || ((((c1*2) + c0) + c2) <= 2)) && (((0 <= (c0 + c1)) || (c2 <= c0)) && ((min(c0, c2) + c1) <= 0)))) ||
 ...
 rewrite(max(min((y + c0), x), (min(y, c1) + c0)), min(max(x, (c0 + c1)), (y + c0))) ||
