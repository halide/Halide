...
Offset<Serialize::Type> Serializer::serialize_type(FlatBufferBuilder &builder, const Type &type) {
    ...
    auto code_serialized = Serialize::TypeCode(code);
    auto type_obj = Serialize::CreateType(builder, code_serialized, bits, lanes);
    return type_obj;
}
...
std::pair<Serialize::Stmt, Offset<void>> Serializer::serialize_stmt(FlatBufferBuilder &builder, const Stmt &stmt) {
    ...
    case IRNodeType::For: {
        ...
        Serialize::ForType for_type = serialize_for_type(for_stmt->for_type);
    ...
    case IRNodeType::Allocate: {
        ...
        Serialize::MemoryType memory_type = serialize_memory_type(allocate_stmt->memory_type);
    ...
    case IRNodeType::Realize: {
        ...
        Serialize::MemoryType memory_type = serialize_memory_type(realize_stmt->memory_type);
...
Offset<Serialize::Range> Serializer::serialize_range(FlatBufferBuilder &builder, const Range &range) {
    ...
    auto extent_serialized = serialize_expr(builder, extent);
    auto range_obj = Serialize::CreateRange(builder, min_serialized.first, min_serialized.second, extent_serialized.first, extent_serialized.second);
    return range_obj;
}
...
Offset<Serialize::LoopLevel> Serializer::serialize_loop_level(FlatBufferBuilder &builder, const LoopLevel &loop_level) {
    ...
    auto loop_level_obj = Serialize::CreateLoopLevel(builder, func_name_serialized, stage_index, var_name_serialized, is_rvar, locked);
...
Offset<Serialize::FuncSchedule> Serializer::serialize_func_schedule(FlatBufferBuilder &builder, const FuncSchedule &func_schedule) {
    ...
    Serialize::MemoryType memory_type = serialize_memory_type(func_schedule.memory_type());
