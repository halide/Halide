...
void bounds_test() {
    ...
    check(scope, Load::make(Int(8), "buf", x, BufferRef<>(), Parameter()), make_const(Int(8), -128), make_const(Int(8), 127));
    ...
    Expr u8_1 = cast<uint8_t>(Load::make(Int(8), "buf", x, BufferRef<>(), Parameter()));
    Expr u8_2 = cast<uint8_t>(Load::make(Int(8), "buf", x + 17, BufferRef<>(), Parameter()));
