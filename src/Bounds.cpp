...
private:
    ...
    void visit(const Call *op) {
        ...
        if (const_args &&
        ...
        } else if (op->name == "_halide_buffer_get_min" ||
            ...
            interval = Interval(Call::make(Int(32), "_halide_buffer_get_min", op->args, Call::Extern),
                                Call::make(Int(32), "_halide_buffer_get_max", op->args, Call::Extern));
