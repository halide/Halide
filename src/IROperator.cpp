...
void range_reduce_log(Expr input, Expr *reduced, Expr *exponent) {
    ...
    Expr non_exponent_mask = IntImm::make(int_type, 0x807fffff);
...
Expr halide_log(Expr x_full) {
    ...
    Expr nan = Call::make(Float(32), "nan_f32", {}, Call::Extern);
    Expr neg_inf = Call::make(Float(32), "neg_inf_f32", {}, Call::Extern);
...
Expr halide_exp(Expr x_full) {
    ...
    Expr inf = Call::make(Float(32), "inf_f32", {}, Call::Extern);
