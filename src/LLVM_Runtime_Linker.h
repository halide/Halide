...
/** Create an llvm module containing the support code for amdgpu device. */
std::unique_ptr<llvm::Module> get_initial_module_for_amdgpu_device(Target, llvm::LLVMContext *c);
