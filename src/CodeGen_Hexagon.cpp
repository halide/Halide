...
// TODO: is there a numerical correlation (e.g. the 128B version can be mathematically
// derived from the 64B version)? That would allow us to dodge this macro stuff.
#ifdef WITH_HEXAGON
#define MAKE_ID_PAIR(i64) IdPair{ (i64), (i64##_128B) }
#else
#define MAKE_ID_PAIR(i64) IdPair{ Intrinsic::not_intrinsic, Intrinsic::not_intrinsic }
#endif
...
static constexpr HvxIntrinsic intrinsic_wrappers[] = {
    ...
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vunpackub), u16v2, "unpack.vub", {u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vunpackuh), u32v2, "unpack.vuh", {u16v1} },
    ...
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsathub),  u8v1,  "trunc_satub.vh",  {i16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsatwh),   i16v1, "trunc_sath.vw",   {i32v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsatuwuh), u16v1, "trunc_satuh.vuw",   {u32v2} },    // v62 or later

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vroundhub), u8v1,  "trunc_satub_rnd.vh", {i16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vroundhb),  i8v1,  "trunc_satb_rnd.vh",  {i16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vroundwuh), u16v1, "trunc_satuh_rnd.vw", {i32v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vroundwh),  i16v1, "trunc_sath_rnd.vw",  {i32v2} },

    // vpack does not interleave its input.
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vpackhub_sat), u8v1,  "pack_satub.vh", {i16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vpackwuh_sat), u16v1, "pack_satuh.vw", {i32v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vpackhb_sat),  i8v1,  "pack_satb.vh",  {i16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vpackwh_sat),  i16v1, "pack_sath.vw",  {i32v2} },
    ...
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddb),     i8v1,  "add.vb.vb",     {i8v1,  i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddh),     i16v1, "add.vh.vh",     {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddw),     i32v1, "add.vw.vw",     {i32v1, i32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddb_dv),  i8v2,  "add.vb.vb.dv",  {i8v2,  i8v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddh_dv),  i16v2, "add.vh.vh.dv",  {i16v2, i16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddw_dv),  i32v2, "add.vw.vw.dv",  {i32v2, i32v2} },
    ...
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddubh), u16v2, "add_vuh.vub.vub", {u8v1, u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddhw), i32v2, "add_vw.vh.vh", {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vadduhw), u32v2, "add_vuw.vuh.vuh", {u16v1, u16v1} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubb),     i8v1,  "sub.vb.vb",     {i8v1,  i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubh),     i16v1, "sub.vh.vh",     {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubw),     i32v1, "sub.vw.vw",     {i32v1, i32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubb_dv),  i8v2,  "sub.vb.vb.dv",  {i8v2,  i8v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubh_dv),  i16v2, "sub.vh.vh.dv",  {i16v2, i16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubw_dv),  i32v2, "sub.vw.vw.dv",  {i32v2, i32v2} },

    // Widening subtracts. There are other instructions that subtact two vub and two vuh but do not widen.
    // To differentiate those from the widening ones, we encode the return type in the name here.
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsububh), u16v2, "sub_vuh.vub.vub", {u8v1, u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsububh), i16v2, "sub_vh.vub.vub", {u8v1, u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubhw), i32v2, "sub_vw.vh.vh", {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubuhw), u32v2, "sub_vuw.vuh.vuh", {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubuhw), i32v2, "sub_vw.vuh.vuh", {u16v1, u16v1} },


    // Adds/subtract of unsigned values with saturation.
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddubsat),    u8v1,  "satub_add.vub.vub",    {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vadduhsat),    u16v1, "satuh_add.vuh.vuh",    {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vadduwsat),    u32v1, "satuw_add.vuw.vuw",    {u32v1, u32v1} },  // v62 or later
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddhsat),     i16v1, "sath_add.vh.vh",       {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddwsat),     i32v1, "satw_add.vw.vw",       {i32v1, i32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddubsat_dv), u8v2,  "satub_add.vub.vub.dv", {u8v2,  u8v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vadduhsat_dv), u16v2, "satuh_add.vuh.vuh.dv", {u16v2, u16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vadduwsat_dv), u32v2, "satuw_add.vuw.vuw.dv", {u32v2, u32v2} },  // v62 or later
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddhsat_dv),  i16v2, "sath_add.vh.vh.dv",    {i16v2, i16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaddwsat_dv),  i32v2, "satw_add.vw.vw.dv",    {i32v2, i32v2} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsububsat),    u8v1,  "satub_sub.vub.vub",    {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubuhsat),    u16v1, "satuh_sub.vuh.vuh",    {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubhsat),     i16v1, "sath_sub.vh.vh",       {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubwsat),     i32v1, "satw_sub.vw.vw",       {i32v1, i32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsububsat_dv), u8v2,  "satub_sub.vub.vub.dv", {u8v2,  u8v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubuhsat_dv), u16v2, "satuh_sub.vuh.vuh.dv", {u16v2, u16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubhsat_dv),  i16v2, "sath_sub.vh.vh.dv",    {i16v2, i16v2} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vsubwsat_dv),  i32v2, "satw_sub.vw.vw.dv",    {i32v2, i32v2} },

    // Absolute value:
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vabsh),   u16v1, "abs.vh", {i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vabsw),   u32v1, "abs.vw", {i32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vabsb),   u8v1, "abs.vb", {i8v1}, HvxIntrinsic::v65OrLater },

    // Absolute difference:
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vabsdiffub),  u8v1,  "absd.vub.vub", {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vabsdiffuh),  u16v1, "absd.vuh.vuh", {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vabsdiffh),   u16v1, "absd.vh.vh",   {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vabsdiffw),   u32v1, "absd.vw.vw",   {i32v1, i32v1} },

    // Averaging:
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vavgub), u8v1,  "avg.vub.vub", {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vavguh), u16v1, "avg.vuh.vuh", {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vavgh),  i16v1, "avg.vh.vh",   {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vavgw),  i32v1, "avg.vw.vw",   {i32v1, i32v1} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vavgubrnd), u8v1,  "avg_rnd.vub.vub", {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vavguhrnd), u16v1, "avg_rnd.vuh.vuh", {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vavghrnd),  i16v1, "avg_rnd.vh.vh",   {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vavgwrnd),  i32v1, "avg_rnd.vw.vw",   {i32v1, i32v1} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vnavgub), i8v1,  "navg.vub.vub", {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vnavgh),  i16v1, "navg.vh.vh",   {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vnavgw),  i32v1, "navg.vw.vw",   {i32v1, i32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vavgb),  i8v1,  "avg.vb.vb",   {i8v1, i8v1}, HvxIntrinsic::v65OrLater },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vavguw), u32v1, "avg.vuw.vuw", {u32v1, u32v1}, HvxIntrinsic::v65OrLater },

    // Non-widening multiplication:
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyih),  i16v1, "mul.vh.vh",   {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyihb), i16v1, "mul.vh.b",    {i16v1, i8}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyiwh), i32v1, "mul.vw.h",    {i32v1, i16}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyiwb), i32v1, "mul.vw.b",    {i32v1, i8}, HvxIntrinsic::BroadcastScalarsToWords },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyih_acc),  i16v1, "add_mul.vh.vh.vh",   {i16v1, i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyihb_acc), i16v1, "add_mul.vh.vh.b",    {i16v1, i16v1, i8}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyiwh_acc), i32v1, "add_mul.vw.vw.h",    {i32v1, i32v1, i16}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyiwb_acc), i32v1, "add_mul.vw.vw.b",    {i32v1, i32v1, i8}, HvxIntrinsic::BroadcastScalarsToWords },

    // Widening vector multiplication:
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyubv), u16v2, "mpy.vub.vub", {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyuhv), u32v2, "mpy.vuh.vuh", {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpybv),  i16v2, "mpy.vb.vb",   {i8v1,  i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyhv),  i32v2, "mpy.vh.vh",   {i16v1, i16v1} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyubv_acc), u16v2, "add_mpy.vuh.vub.vub", {u16v2, u8v1, u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyuhv_acc), u32v2, "add_mpy.vuw.vuh.vuh", {u32v2, u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpybv_acc),  i16v2, "add_mpy.vh.vb.vb",    {i16v2, i8v1, i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyhv_acc),  i32v2, "add_mpy.vw.vh.vh",    {i32v2, i16v1, i16v1} },

    // Inconsistencies: both are vector instructions despite the
    // missing 'v', and the signedness is indeed swapped.
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpybusv), i16v2, "mpy.vub.vb",  {u8v1,  i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyhus),  i32v2, "mpy.vh.vuh",  {i16v1, u16v1} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpybusv_acc), i16v2, "add_mpy.vh.vub.vb",  {i16v2, u8v1,  i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyhus_acc),  i32v2, "add_mpy.vw.vh.vuh",  {i32v2, i16v1, u16v1} },

    // Widening scalar multiplication:
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyub),  u16v2, "mpy.vub.ub",  {u8v1,  u8}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyuh),  u32v2, "mpy.vuh.uh",  {u16v1, u16}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyh),   i32v2, "mpy.vh.h",    {i16v1, i16}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpybus), i16v2, "mpy.vub.b",   {u8v1,  i8}, HvxIntrinsic::BroadcastScalarsToWords },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyub_acc),   u16v2, "add_mpy.vuh.vub.ub",   {u16v2, u8v1,  u8}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyuh_acc),   u32v2, "add_mpy.vuw.vuh.uh",   {u32v2, u16v1, u16}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpybus_acc),  i16v2, "add_mpy.vh.vub.b",     {i16v2, u8v1,  i8}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyhsat_acc), i32v2, "satw_add_mpy.vw.vh.h", {i32v2, i16v1, i16}, HvxIntrinsic::BroadcastScalarsToWords },

    // Widening vector multiplication, with horizontal reduction.
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vrmpyubv),  u32v1, "add_4mpy.vub.vub", {u8v1, u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vrmpybv),   i32v1, "add_4mpy.vb.vb",   {i8v1, i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vrmpybusv), i32v1, "add_4mpy.vub.vb",  {i8v1, i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vrmpyubv_acc),  u32v1, "acc_add_4mpy.vuw.vub.vub", {u32v1, u8v1, u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vrmpybv_acc),   i32v1, "acc_add_4mpy.vw.vb.vb",   {i32v1, i8v1, i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vrmpybusv_acc), i32v1, "acc_add_4mpy.vw.vub.vb",  {i32v1, i8v1, i8v1} },

    // Widening scalar multiplication, with horizontal reduction.
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vdmpybus), i16v1, "add_2mpy.vub.b", {u8v1, i16}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vdmpyhb),  i32v1, "add_2mpy.vh.b",  {i16v1, i16}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vdmpybus_acc), i16v1, "acc_add_2mpy.vh.vub.b", {i16v1, u8v1, i16}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vdmpyhb_acc),  i32v1, "acc_add_2mpy.vw.vh.b",  {i32v1, i16v1, i16}, HvxIntrinsic::BroadcastScalarsToWords },
    ...
    //{ MAKE_ID_PAIR(Intrinsic::hexagon_V6_vdmpybus_dv), i16v2, "add_2mpy.vub.b.dv", {u8v2, i32} },
    //{ MAKE_ID_PAIR(Intrinsic::hexagon_V6_vdmpyhb_dv), i32v2, "add_2mpy.vh.b.dv", {i16v2, i32} },
    //{ MAKE_ID_PAIR(Intrinsic::hexagon_V6_vdmpybus_dv_acc), i16v2, "acc_add_2mpy.vh.vub.b.dv", {i16v2, u8v2, i32} },
    //{ MAKE_ID_PAIR(Intrinsic::hexagon_V6_vdmpyhb_dv_acc), i32v2, "acc_add_2mpy.vw.vh.b.dv", {i32v2, i16v2, i32} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vrmpybus), i32v1, "add_4mpy.vub.b",  {u8v1, i32} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vrmpyub),  u32v1, "add_4mpy.vub.ub", {u8v1, u32} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vrmpybus_acc), i32v1, "acc_add_4mpy.vw.vub.b",  {i32v1, u8v1, i32} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vrmpyub_acc),  u32v1, "acc_add_4mpy.vuw.vub.ub", {u32v1, u8v1, u32} },

    // Multiply keep high half, with multiplication by 2.
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyhvsrs), i16v1, "trunc_satw_mpy2_rnd.vh.vh", {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyhss), i16v1, "trunc_satw_mpy2.vh.h", {i16v1, i16}, HvxIntrinsic::BroadcastScalarsToWords },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmpyhsrs), i16v1, "trunc_satw_mpy2_rnd.vh.h", {i16v1, i16}, HvxIntrinsic::BroadcastScalarsToWords },

    // Select/conditionals. Conditions are always signed integer
    // vectors (so widening sign extends).
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmux), i8v1,  "mux.vb.vb",  {i8v1,  i8v1,  i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmux), i16v1, "mux.vh.vh",  {i16v1, i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmux), i32v1, "mux.vw.vw",  {i32v1, i32v1, i32v1} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_veqb), i8v1,  "eq.vb.vb",  {i8v1,  i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_veqh), i16v1, "eq.vh.vh",  {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_veqw), i32v1, "eq.vw.vw",  {i32v1, i32v1} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vgtub), i8v1,  "gt.vub.vub", {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vgtuh), i16v1, "gt.vuh.vuh", {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vgtuw), i32v1, "gt.vuw.vuw", {u32v1, u32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vgtb),  i8v1,  "gt.vb.vb",   {i8v1,  i8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vgth),  i16v1, "gt.vh.vh",   {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vgtw),  i32v1, "gt.vw.vw",   {i32v1, i32v1} },

    // Min/max:
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmaxub), u8v1,  "max.vub.vub", {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmaxuh), u16v1, "max.vuh.vuh", {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmaxh),  i16v1, "max.vh.vh",   {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vmaxw),  i32v1, "max.vw.vw",   {i32v1, i32v1} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vminub), u8v1,  "min.vub.vub", {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vminuh), u16v1, "min.vuh.vuh", {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vminh),  i16v1, "min.vh.vh",   {i16v1, i16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vminw),  i32v1, "min.vw.vw",   {i32v1, i32v1} },

    // Shifts
    // We map arithmetic and logical shifts to just "shr", depending on type.
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vlsrhv), u16v1, "shr.vuh.vuh", {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vlsrwv), u32v1, "shr.vuw.vuw", {u32v1, u32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vasrhv), i16v1, "shr.vh.vuh",   {i16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vasrwv), i32v1, "shr.vw.vuw",   {i32v1, u32v1} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaslhv), u16v1, "shl.vuh.vuh", {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaslwv), u32v1, "shl.vuw.vuw", {u32v1, u32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaslhv), i16v1, "shl.vh.vuh",   {i16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaslwv), i32v1, "shl.vw.vuw",   {i32v1, u32v1} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vlsrh),  u16v1, "shr.vuh.uh", {u16v1, u16} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vlsrw),  u32v1, "shr.vuw.uw", {u32v1, u32} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vasrh),  i16v1, "shr.vh.uh",   {i16v1, u16} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vasrw),  i32v1, "shr.vw.uw",   {i32v1, u32} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaslh),  u16v1, "shl.vuh.uh", {u16v1, u16} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaslw),  u32v1, "shl.vuw.uw", {u32v1, u32} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaslh),  i16v1, "shl.vh.uh",   {i16v1, u16} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaslw),  i32v1, "shl.vw.uw",   {i32v1, u32} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vasrh_acc), i16v1, "add_shr.vh.vh.uh", {i16v1, i16v1, i16}, HvxIntrinsic::BroadcastScalarsToWords | HvxIntrinsic::v65OrLater },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaslh_acc), i16v1, "add_shl.vh.vh.uh", {i16v1, i16v1, i16}, HvxIntrinsic::BroadcastScalarsToWords | HvxIntrinsic::v65OrLater },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vasrw_acc), i32v1, "add_shr.vw.vw.uw", {i32v1, i32v1, i32} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vaslw_acc), i32v1, "add_shl.vw.vw.uw", {i32v1, i32v1, i32} },

    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vasrwh), i16v1, "trunc_shr.vw.uw",   {i32v2, u32} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vasrhubsat), u8v1, "trunc_satub_shr.vh.uh",  {i16v2, u16} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vasrwuhsat), u16v1, "trunc_satuh_shr.vw.uw", {i32v2, u32} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vasrwhsat),  i16v1, "trunc_sath_shr.vw.uw",  {i32v2, u32} },

    // Bitwise operators
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vand),  u8v1,  "and.vb.vb",  {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vand),  u16v1, "and.vh.vh",  {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vand),  u32v1, "and.vw.vw",  {u32v1, u32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vor),   u8v1,  "or.vb.vb",   {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vor),   u16v1, "or.vh.vh",   {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vor),   u32v1, "or.vw.vw",   {u32v1, u32v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vxor),  u8v1,  "xor.vb.vb",  {u8v1,  u8v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vxor),  u16v1, "xor.vh.vh",  {u16v1, u16v1} },
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vxor),  u32v1, "xor.vw.vw",  {u32v1, u32v1} },
    ...
    // Broadcasts
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_lvsplatb), u8v1,   "splat_v62.b", {u8}  },   // v62 or later
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_lvsplath), u16v1,  "splat_v62.h", {u16} },   // v62 or later
    ...
    { MAKE_ID_PAIR(Intrinsic::hexagon_V6_vpopcounth), u16v1, "popcount.vh", {u16v1} },
...
Value *CodeGen_Hexagon::interleave_vectors(const vector<llvm::Value *> &v) {
    ...
    if (v.size() == 2) {
        ...
        if (result_elements == native_elements && (element_bits == 8 || element_bits == 16)) {
            ...
            // vshuff.
            IdPair vshuff = element_bits == 8
                ? MAKE_ID_PAIR(Intrinsic::hexagon_V6_vshuffb)
                : MAKE_ID_PAIR(Intrinsic::hexagon_V6_vshuffh);
            return call_intrin_cast(native_ty, vshuff.get(is_128B), {concat_vectors({a, b})});
        } else {
...
Value *CodeGen_Hexagon::shuffle_vectors(Value *a, Value *b,
    ...
    if (max < a_elements) {
        ...
        llvm::Function *vcombine =
            Intrinsic::getDeclaration(module.get(), MAKE_ID_PAIR(Intrinsic::hexagon_V6_vcombine).get(is_128B));
    ...
    if (stride == 1) {
        if (result_ty == native2_ty && a_ty == native_ty && b_ty == native_ty) {
            ...
            return call_intrin_cast(native2_ty, MAKE_ID_PAIR(Intrinsic::hexagon_V6_vcombine).get(is_128B), {b, a});
        }
        if (result_ty == native_ty && a_ty == native2_ty && max < a_elements) {
            // Extract a and b from a double vector.
            b = call_intrin_cast(native_ty, MAKE_ID_PAIR(Intrinsic::hexagon_V6_hi).get(is_128B), {a});
            a = call_intrin_cast(native_ty, MAKE_ID_PAIR(Intrinsic::hexagon_V6_lo).get(is_128B), {a});
            a_ty = a->getType();
            b_ty = b->getType();
        ...
        if (result_ty == native_ty && a_ty == native_ty && b_ty == native_ty) {
            ...
            Intrinsic::ID intrin_id = MAKE_ID_PAIR(Intrinsic::hexagon_V6_valignb).get(is_128B);
        ...
        for (int i = 0; i < result_elements; i += native_elements) {
            ...
            if (element_bits == 8) {
                IdPair intrin =
                    start == 0 ? MAKE_ID_PAIR(Intrinsic::hexagon_V6_vpackeb) : MAKE_ID_PAIR(Intrinsic::hexagon_V6_vpackob);
                ret_i = call_intrin_cast(native_ty, intrin.get(is_128B), {ab_i1, ab_i0});
            } else if (element_bits == 16) {
                IdPair intrin =
                    start == 0 ? MAKE_ID_PAIR(Intrinsic::hexagon_V6_vpackeh) : MAKE_ID_PAIR(Intrinsic::hexagon_V6_vpackoh);
                ret_i = call_intrin_cast(native_ty, intrin.get(is_128B), {ab_i1, ab_i0});
                ...
                IdPair intrin =
                    start == 0 ? MAKE_ID_PAIR(Intrinsic::hexagon_V6_lo) : MAKE_ID_PAIR(Intrinsic::hexagon_V6_hi);
...
Value *CodeGen_Hexagon::vlut(Value *lut, Value *idx, int min_index, int max_index) {
    ...
    for (int i = 0; i <= max_index; i += native_lut_elements) {
        ...
        lut_slice = call_intrin_cast(lut_slice->getType(), vshuff.get(is_128B), {lut_slice});
    ...
    for (int i = 0; i < idx_elements; i += native_idx_elements) {
        ...
        if (lut_ty->getScalarSizeInBits() == 16) {
            ...
            idx_i = call_intrin_cast(idx_i->getType(), MAKE_ID_PAIR(Intrinsic::hexagon_V6_vshuffb).get(is_128B), {idx_i});
        }
        ...
        for (int j = 0; j < static_cast<int>(lut_slices.size()); j++) {
            for (int k = 0; k < lut_passes; k++) {
                ...
                if (result_i == nullptr) {
                    ...
                    result_i = call_intrin_cast(native_result_ty, vlut_acc.get(is_128B),
...
Value *CodeGen_Hexagon::vlut(Value *lut, const vector<int> &indices) {
    ...
    case 32:
        ...
        break;
    default:
        internal_error << "Cannot constant select vector of " << element_ty->getScalarSizeInBits() << "\n";
    }
...
void CodeGen_Hexagon::visit(const Call *op) {
    ...
    if (op->is_intrinsic(Call::gather)) {
        ...
        return;
               ...
               op->type.is_vector() && ((op->type.is_uint() && (op->type.bits() == 8 || op->type.bits() == 16)) || (op->type.is_int() && (op->type.bits() == 16 || op->type.bits() == 32)))) {
