#ifndef HALIDE__bin___host___demo_h
#define HALIDE__bin___host___demo_h
#include <stdint.h>
...
int demo(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_filter_buffer, struct halide_buffer_t *_bias_buffer, struct halide_buffer_t *_relu_buffer);

HALIDE_FUNCTION_ATTRS
int demo_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *demo_metadata();
