...
bool State::compute_featurization(const FunctionDAG &dag, const Anderson2021Params &params, const Target &target, StageMap<ScheduleFeatures> *features, Statistics &stats, bool verbose) const {
    ...
    Timer timer;
    feature_root->compute_features(dag, params, target, sites, 1, 1, nullptr, nullptr, *feature_root,
                                   GPULoopInfo(feature_root.get()), true, total_shared_mem_alloc_sizes,
                                   nullptr, nullptr, nullptr, features, stats, verbose);
