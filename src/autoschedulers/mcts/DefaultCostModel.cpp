...
#include "mcts_cost_model.h"
#include "mcts_train_cost_model.h"
...
void DefaultCostModel::set_pipeline_features(const Internal::Autoscheduler::FunctionDAG &dag,
                                             const Internal::Autoscheduler::MctsParams &params) {
...
float DefaultCostModel::backprop(const Runtime::Buffer<const float> &true_runtimes, float learning_rate) {
    ...
    int result = mcts_train_cost_model(num_stages,
                                  cursor,
                                  num_cores,
                                  pipeline_feat_queue,
                                  schedule_feat_queue,
...
void DefaultCostModel::evaluate_costs() {
    ...
    int result = mcts_cost_model(num_stages,
                            cursor,
                            num_cores,
                            pipeline_feat_queue,
                            schedule_feat_queue,
