...
public:
    ...
    struct EmitOptions {
        bool emit_o, emit_h, emit_cpp, emit_assembly, emit_bitcode, emit_stmt, emit_stmt_html, emit_static_library, emit_javascript;
        ...
        EmitOptions()
            : emit_o(false), emit_h(false), emit_cpp(false), emit_assembly(false),
              ...
              emit_static_library(false), emit_javascript(false) {}
    };
