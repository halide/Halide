...
#if defined(_MSC_VER)
#define HALIDE_IMPORT_SYMBOL __declspec(dllimport)
#else
#define HALIDE_IMPORT_SYMBOL
#endif
...
#define HALIDE_GENERATOR_PYSTUB(GEN_REGISTRY_NAME, MODULE_NAME)                                                                                \
    ...
    extern "C" HALIDE_IMPORT_SYMBOL PyObject *_halide_pystub_impl(const char *module_name, const Halide::Internal::GeneratorFactory &factory); \
