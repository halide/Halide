...
HALIDE_ALWAYS_INLINE
auto rewriter(const Expr &e, halide_type_t expected_type) noexcept -> Rewriter<decltype(pattern_arg(e))> {
    return {pattern_arg(e), expected_type};
}
