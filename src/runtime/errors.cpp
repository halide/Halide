...
WEAK halide_error_code_t halide_error_bounds_inference_call_failed(void *user_context, const char *extern_stage_name, enum halide_error_code_t result) {
    error(user_context)
...
WEAK halide_error_code_t halide_error_extern_stage_failed(void *user_context, const char *extern_stage_name, enum halide_error_code_t result) {
    error(user_context)
...
WEAK halide_error_code_t halide_error_explicit_bounds_too_small(void *user_context, const char *func_name, const char *var_name,
...
WEAK halide_error_code_t halide_error_bad_type(void *user_context, const char *func_name,
...
WEAK halide_error_code_t halide_error_bad_dimensions(void *user_context, const char *func_name,
...
WEAK halide_error_code_t halide_error_access_out_of_bounds(void *user_context, const char *func_name,
...
WEAK halide_error_code_t halide_error_buffer_allocation_too_large(void *user_context, const char *buffer_name, uint64_t allocation_size, uint64_t max_size) {
    error(user_context)
...
WEAK halide_error_code_t halide_error_buffer_extents_negative(void *user_context, const char *buffer_name, int dimension, int extent) {
    error(user_context)
...
WEAK halide_error_code_t halide_error_buffer_extents_too_large(void *user_context, const char *buffer_name, int64_t actual_size, int64_t max_size) {
    error(user_context)
...
WEAK halide_error_code_t halide_error_constraints_make_required_region_smaller(void *user_context, const char *buffer_name,
                                                                               int dimension,
...
WEAK halide_error_code_t halide_error_constraint_violated(void *user_context, const char *var, int val,
...
WEAK halide_error_code_t halide_error_param_too_small_i64(void *user_context, const char *param_name,
...
WEAK halide_error_code_t halide_error_param_too_small_u64(void *user_context, const char *param_name,
...
WEAK halide_error_code_t halide_error_param_too_small_f64(void *user_context, const char *param_name,
...
WEAK halide_error_code_t halide_error_param_too_large_i64(void *user_context, const char *param_name,
...
WEAK halide_error_code_t halide_error_param_too_large_u64(void *user_context, const char *param_name,
...
WEAK halide_error_code_t halide_error_param_too_large_f64(void *user_context, const char *param_name,
...
WEAK halide_error_code_t halide_error_out_of_memory(void *user_context) {
...
WEAK halide_error_code_t halide_error_buffer_argument_is_null(void *user_context, const char *buffer_name) {
    error(user_context)
        << "Buffer argument " << buffer_name << " is nullptr";
    return halide_error_code_buffer_argument_is_null;
}

WEAK halide_error_code_t halide_error_debug_to_file_failed(void *user_context, const char *func,
...
WEAK halide_error_code_t halide_error_unaligned_host_ptr(void *user_context, const char *func,
                                                         int alignment) {
    error(user_context)
...
WEAK halide_error_code_t halide_error_device_dirty_with_no_device_support(void *user_context, const char *func) {
    error(user_context)
        << "The buffer " << func
...
WEAK halide_error_code_t halide_error_host_is_null(void *user_context, const char *func) {
    error(user_context)
        << "The host pointer of " << func
...
WEAK halide_error_code_t halide_error_bad_fold(void *user_context, const char *func_name, const char *var_name,
...
WEAK halide_error_code_t halide_error_bad_extern_fold(void *user_context, const char *func_name,
...
WEAK halide_error_code_t halide_error_fold_factor_too_small(void *user_context, const char *func_name, const char *var_name,
...
WEAK halide_error_code_t halide_error_requirement_failed(void *user_context, const char *condition, const char *message) {
    error(user_context)
        << "Requirement Failed: (" << condition << ") " << message;
    return halide_error_code_requirement_failed;
}

WEAK halide_error_code_t halide_error_specialize_fail(void *user_context, const char *message) {
    error(user_context)
        << "A schedule specialized with specialize_fail() was chosen: " << message;
    return halide_error_code_specialize_fail;
}

WEAK halide_error_code_t halide_error_no_device_interface(void *user_context) {
    error(user_context) << "Buffer has a non-zero device but no device interface.\n";
    return halide_error_code_no_device_interface;
}

WEAK halide_error_code_t halide_error_device_interface_no_device(void *user_context) {
...
WEAK halide_error_code_t halide_error_host_and_device_dirty(void *user_context) {
    error(user_context) << "Buffer has both host and device dirty bits set.\n";
    return halide_error_code_host_and_device_dirty;
}

WEAK halide_error_code_t halide_error_buffer_is_null(void *user_context, const char *routine) {
    error(user_context) << "Buffer pointer passed to " << routine << " is null.\n";
    return halide_error_code_buffer_is_null;
}

WEAK halide_error_code_t halide_error_storage_bound_too_small(void *user_context, const char *func_name, const char *var_name,
...
WEAK halide_error_code_t halide_error_device_crop_failed(void *user_context) {
