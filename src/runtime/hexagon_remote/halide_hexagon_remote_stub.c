...
__QAIC_STUB_EXPORT int __QAIC_STUB(halide_hexagon_remote_initialize_kernels)(const unsigned char* code, int codeLen, halide_hexagon_remote_uintptr_t* module_ptr) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 0;
