...
__QAIC_STUB_EXPORT int __QAIC_STUB(halide_hexagon_remote_run)(halide_hexagon_remote_uintptr_t module_ptr, int offset, const halide_hexagon_remote_buffer* arg_ptrs, int arg_ptrsLen, const int* arg_sizes, int arg_sizesLen, halide_hexagon_remote_buffer* outputs, int outputsLen) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 1;
   return _stub_method_1(_halide_hexagon_remote_handle(), _mid, (uint32_t*)&module_ptr, (uint32_t*)&offset, (void**)&arg_ptrs, (uint32_t*)&arg_ptrsLen, (char**)&arg_sizes, (uint32_t*)&arg_sizesLen, (void**)&outputs, (uint32_t*)&outputsLen);
}
...
__QAIC_STUB_EXPORT int __QAIC_STUB(halide_hexagon_remote_release_kernels)(halide_hexagon_remote_uintptr_t module_ptr) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
   return _stub_method_2(_halide_hexagon_remote_handle(), _mid, (uint32_t*)&module_ptr);
}
#ifdef __cplusplus
}
#endif
