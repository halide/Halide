...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(halide_hexagon_remote_get_symbol_v2)(halide_hexagon_remote_handle_t module_ptr, const char* name, int nameLen, int use_shared_object, halide_hexagon_remote_handle_t* sym_ptr) __QAIC_HEADER_ATTRIBUTE;
