...
static const char strings[358] = "busbwUsagePercentage\0poll_profiler_state\0initialize_kernels\0power_hvx_on_perf\0power_hvx_on_mode\0bwBytePerSec_l32\0bwBytePerSec_u32\0release_kernels\0output_buffers\0mipsPerThread\0input_scalars\0input_buffers\0power_hvx_off\0get_symbol_v2\0power_hvx_on\0set_latency\0set_bus_bw\0module_ptr\0mipsTotal\0read_size\0set_mips\0poll_log\0threads\0sym_ptr\0symbol\0func\0name\0code\0run\0";
static const uint16_t methodStrings[36] = {60,298,161,278,256,113,96,0,244,248,354,267,332,189,146,175,217,267,344,324,21,339,316,307,312,288,130,267,293,41,349,267,78,91,203,231};
static const uint16_t methodStringsArrays[10] = {29,16,35,34,10,26,23,20,32,0};
...
extern "C" {
#endif
static __inline int _skel_method(int (*_pfn)(uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t), uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   uint32_t _in1[1];
   uint32_t _in2[1];
   ...
   _TRY(_nErr, _pfn(*_in0, *_in1, *_in2, *_in3, *_in4, *_in5, *_in6, *_in7, *_in8));
   _CATCH(_nErr) {}
   return _nErr;
}
...
static __inline int _skel_method_8(int (*_pfn)(char*, uint32_t, uint32_t*), uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   char* _in0[1];
   uint32_t _in0Len[1];
   uint32_t _rout1[1];
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(halide_hexagon_remote_skel_invoke)(uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   ...
   {
      case 0:
      return _skel_method_8((void*)__QAIC_IMPL(halide_hexagon_remote_initialize_kernels), _sc, _pra);
      case 1:
