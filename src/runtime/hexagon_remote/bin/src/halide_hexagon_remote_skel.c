...
static __inline int _skel_method_2(int (*_pfn)(uint32_t, uint32_t, void*, uint32_t, void*, uint32_t, uint32_t, char*, uint32_t), uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   uint32_t _in1[1];
   void* _in2[1];
   ...
   _ASSERT(_nErr, (int)((_praIn[2].buf.nLen / 1)) >= (int)(_in5Len[0]));
   _in5[0] = _praIn[2].buf.pv;
   _TRY(_nErr, _pfn(*_in0, *_in1, *_in2, *_in2Len, *_rout3, *_rout3Len, *_in4, *_in5, *_in5Len));
...
static __inline int _skel_method_3(int (*_pfn)(uint32_t, char*, uint32_t, uint32_t*), uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   char* _in1[1];
   uint32_t _in1Len[1];
...
static __inline int _skel_method_4(int (*_pfn)(char*, uint32_t, uint32_t*), uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   char* _in0[1];
   uint32_t _in0Len[1];
   uint32_t _rout1[1];
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(halide_hexagon_remote_skel_invoke)(uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   ...
   {
      case 0:
      return _skel_method_4((void*)__QAIC_IMPL(halide_hexagon_remote_initialize_kernels), _sc, _pra);
      case 1:
      return _skel_method_3((void*)__QAIC_IMPL(halide_hexagon_remote_get_symbol_v2), _sc, _pra);
      case 2:
      return _skel_method_2((void*)__QAIC_IMPL(halide_hexagon_remote_run_v2), _sc, _pra);
      case 3:
      return _skel_method_1((void*)__QAIC_IMPL(halide_hexagon_remote_release_kernels), _sc, _pra);
      case 4:
      return _skel_method((void*)__QAIC_IMPL(halide_hexagon_remote_poll_log), _sc, _pra);
   }
