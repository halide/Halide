...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(halide_hexagon_remote_initialize_kernels)(const unsigned char* code, int codeLen, int init_runtime_offset, halide_hexagon_remote_uintptr_t* module_ptr) __QAIC_HEADER_ATTRIBUTE;
