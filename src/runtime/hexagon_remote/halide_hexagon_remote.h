...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(halide_hexagon_remote_run)(halide_hexagon_remote_uintptr_t module_ptr, int offset, const halide_hexagon_remote_buffer* arg_ptrs, int arg_ptrsLen, const int* arg_sizes, int arg_sizesLen, halide_hexagon_remote_buffer* outputs, int outputsLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(halide_hexagon_remote_release_kernels)(halide_hexagon_remote_uintptr_t module_ptr) __QAIC_HEADER_ATTRIBUTE;
#ifdef __cplusplus
}
#endif
