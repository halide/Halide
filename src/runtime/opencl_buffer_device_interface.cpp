...
int halide_opencl_device_buffer_malloc(void*, buffer_t*);
...
int halide_opencl_copy_buffer_to_host(void*, buffer_t*);
int halide_opencl_copy_buffer_to_device(void*, buffer_t*);
}
...
// buffer versions of device_malloc, copy_to_host, and copy_to_device.
WEAK halide_device_interface opencl_device_interface = {
    halide_use_jit_module,
    halide_release_jit_module,
    halide_opencl_device_buffer_malloc,
    halide_opencl_device_free,
    halide_opencl_device_sync,
    halide_opencl_device_release,
    halide_opencl_copy_buffer_to_host,
    halide_opencl_copy_buffer_to_device,
};
