...
typedef int (*remote_power_perf_fn)(int, unsigned int, unsigned int, int, unsigned int, unsigned int, unsigned int, int, int);
...
WEAK int init_hexagon_runtime(void *user_context) {
    ...
    get_symbol(user_context, "halide_hexagon_remote_power_hvx_on_mode", remote_power_hvx_on_mode, /* required */ false);
    get_symbol(user_context, "halide_hexagon_remote_power_hvx_on_perf", remote_power_hvx_on_perf, /* required */ false);
...
WEAK int halide_hexagon_power_hvx_on_perf(void *user_context, halide_hvx_power_perf_t *perf) {
    ...
    result = remote_power_hvx_on_perf(perf->set_mips,
                                      ...
                                      perf->mipsTotal,
                                      perf->set_bus_bw,
                                      (perf->bwBytePerSec >> 32),
                                      (perf->bwBytePerSec & 0xffffffff),
