...
/**
 * halide_hexagon_dmart_wrap_buffer
 * in: halide_buffer_t*
 * in: unsigned char
 * out: int
 */
extern int halide_hexagon_dmart_wrap_buffer(void *user_context, halide_buffer_t* buf, void *inframe);

/**
 * halide_hexagon_dmart_release_wrapper
 * in: halide_buffer_t*
 * out: int
 */
extern int halide_hexagon_dmart_release_wrapper(void *user_context, halide_buffer_t* buf);
 ...
 * void* ptr */
int halide_buffer_copy(void *user_context, halide_buffer_t *src_buf, void *ptr, halide_buffer_t *dst_buf);
