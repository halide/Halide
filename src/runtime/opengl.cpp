...
template<class T>
__attribute__((always_inline)) void halide_to_interleaved(const buffer_t *src_buf, T *dst) {
...
template<class T>
__attribute__((always_inline)) void interleaved_to_halide(void *user_context, const T *src, int src_channels, buffer_t *dst_buf) {
