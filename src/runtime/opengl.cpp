...
WEAK int halide_opengl_device_malloc_may_be_zero_copy(void *user_context, struct buffer_t *buf) {
    return halide_default_device_malloc_may_be_zero_copy(user_context, buf, &opengl_device_interface);
}

WEAK int halide_opengl_device_free_may_be_zero_copy(void *user_context, struct buffer_t *buf) {
    return halide_default_device_free_may_be_zero_copy(user_context, buf, &opengl_device_interface);
}
...
WEAK halide_device_interface opengl_device_interface = {
    ...
    halide_opengl_device_malloc_may_be_zero_copy,
    halide_opengl_device_free_may_be_zero_copy,
};
