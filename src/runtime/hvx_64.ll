...
define weak_odr <64 x i8> @halide.hexagon.trunc_satub_shr.vw.w(<64 x i32> %arg0, i32 %arg1) nounwind uwtable readnone alwaysinline {
  ...
  %hilo = tail call <32 x i32> @llvm.hexagon.V6.vcombine(<16 x i32> %hi, <16 x i32> %lo)
  %vp_half = bitcast <32 x i32> %hilo to <64 x i16>
  %vp_half_deint = call <64 x i16> @halide.hexagon.deinterleave.vh(<64 x i16> %vp_half)
  %vp = bitcast <64 x i16> %vp_half_deint to <32 x i32>
  %e = call <16 x i32> @llvm.hexagon.V6.lo(<32 x i32> %vp)
  %o = call <16 x i32> @llvm.hexagon.V6.hi(<32 x i32> %vp)
