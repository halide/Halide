...
/** Define halide_printf to catch debugging output, informational
  ...
  * PrintStmt in IR. Also called by defaul halide_error
  * implementation.
  *
...
/** Define halide_error to catch errors messages at runtime.  such as
 * bounds checking failures. Per the description above, use
 * halide_set_error_handler in JITted code and provide an
 * implementation of halide_error in AOT code.
 * See Func::set_error_handler.
 */
