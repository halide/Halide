...
typedef enum halide_target_feature_t {
    ...
    halide_target_feature_allow_strict_float = 50, ///< Allow fine grained control of floating-point strictness. DEfault is fast, but strict_float may be used to guarantee IEEE semantics.
    halide_target_feature_force_strict_float = 51, ///< Turn off all non-IEEE floating-point optimization. Currently applies only to LLVM targets.
