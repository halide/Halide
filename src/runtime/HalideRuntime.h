...
typedef enum halide_target_feature_t {
    ...
    halide_target_feature_javascript = 32, ///< Compile to JavaScript and execute immediately. Requires JIT and only works with realize. (For testing mainly.)
    halide_target_feature_javascript_simd = 33, ///< Enable SIMD.js use for vectorization.
    halide_target_feature_javascript_v8 = 34, ///< Use the V8 JavaScript engine.
    halide_target_feature_javascript_spidermonkey = 35, ///< Use the SpiderMonkey JavaScript engine.
