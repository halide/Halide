...
typedef enum halide_target_feature_t {
    ...
    halide_target_feature_new_autoscheduler = 60, ///< Use the prototype second-generation autoscheduler
    halide_target_feature_autotune = 61, ///< Use the prototype second-generation autoscheduler
    halide_target_feature_end = 62 ///< A sentinel. Every target is considered to have this feature, and setting this feature does nothing.
