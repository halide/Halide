...
struct halide_device_interface {
    ...
    int (*device_malloc_may_be_zero_copy)(void *user_context, struct buffer_t *buf);
    int (*device_free_may_be_zero_copy)(void *user_context, struct buffer_t *buf);
};
...
extern WEAK int halide_default_device_malloc_may_be_zero_copy(void *user_context, struct buffer_t *buf,
							      const struct halide_device_interface *device_interface);
extern WEAK int halide_default_device_free_may_be_zero_copy(void *user_context, struct buffer_t *buf,
							    const struct halide_device_interface *device_interface);
