...
define weak_odr <16 x i16> @wmul_pmaddub_avx2(<16 x i8> %a, <16 x i8> %b) nounwind alwaysinline {
  %1 = zext <16 x i8> %a to <16 x i16>
  %2 = zext <16 x i8> %b to <16 x i16>
  %3 = bitcast <16 x i16> %1 to <32 x i8>
  %4 = bitcast <16 x i16> %2 to <32 x i8>
  %res = tail call <16 x i16> @llvm.x86.avx2.pmadd.ub.sw(<32 x i8> %3, <32 x i8> %4)
  ret <16 x i16> %res
}
