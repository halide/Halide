 ...
 *out: Error/Success */
extern int halide_hexagon_dmart_set_dma_handle(void* user_context, p_dma_context pdma_context, void *handle, uintptr_t frame);

/**
 * halide_hexagon_dmart_set_chroma_stride
 * in: stride set the chroma stride for the frame
 * out: Error/Success */
extern int halide_hexagon_dmart_set_chroma_stride(void* user_context, p_dma_context pdma_context, uintptr_t frame, int stride);

/**
 * halide_hexagon_dmart_set_luma_stride
 * in: stride Set the luma stride for the frame
 * out: Error/Success */
extern int halide_hexagon_dmart_set_luma_stride(void* user_context, p_dma_context pdma_context, uintptr_t frame, int stride);

/**
 * halide_hexagon_dmart_set_fold_storage
 * out: fold_id fold id
 * out: Error/Success */
extern int halide_hexagon_dmart_set_fold_storage(void* user_context, p_dma_context pdma_context, uintptr_t addr, uintptr_t tcm_region, \
 ...
 * out: Error/Success  */
extern int halide_hexagon_dmart_get_update_params(void* user_context, p_dma_context pdma_context, uintptr_t dev_buf, t_dma_move_params* update_param);
 ...
 * out: Error/Success  */
extern int halide_hexagon_dmart_get_prepare_params(void* user_context, p_dma_context pdma_context, uintptr_t frame, t_dma_prepare_params* prepare_param);
 ...
 * out: Error/Success */
extern int halide_hexagon_dmart_get_tcm_desc_params(void* user_context, p_dma_context pdma_context, uintptr_t dev_buf, uintptr_t *tcm_region,
 ...
 * out: bool lastFrame
 */
extern int halide_hexagon_dmart_get_last_frame(void* user_context, p_dma_context pdma_context, uintptr_t frame, bool *last_frame);
 ...
 * in: addr_t frame
 * out: bool read_flag */
extern int halide_hexagon_dmart_is_buffer_read(void* user_context, p_dma_context pdma_context, uintptr_t frame, bool* is_read);

/**
 * halide_hexagon_dmart_get_fold_size
 * in: addr_t frame
 * out: unsigned int size */
extern int halide_hexagon_dmart_get_fold_size(void* user_context, p_dma_context pdma_context, uintptr_t frame);
 ...
 * out: Error/Success */
extern int halide_hexagon_dmart_allocate_dma(void* user_context, p_dma_context pdma_context, uintptr_t frame, bool* dma_allocate);

/**
 * halide_hexagon_dmart_get_dma_handle
 * in: addr_t frame
 * out: void* handle */
extern void* halide_hexagon_dmart_get_dma_handle(void* user_context, p_dma_context pdma_context, uintptr_t frame);
 ...
 * out: fold_id
 * out: int */
extern int halide_hexagon_dmart_get_free_fold (void* user_context, p_dma_context pdma_context, bool *free_fold, int* store_id);

/**
 * halide_hexagon_dmart_get_frame_index
 * in: addr_t frame
 * out: frameIDx */
extern int halide_hexagon_dmart_get_frame_index(void* user_context, p_dma_context pdma_context, uintptr_t frame);
...
extern int halide_hexagon_dmart_set_host_frame (void* user_context, p_dma_context pdma_context, uintptr_t frame,int type, int d,
...
extern int halide_hexagon_dmart_get_num_components (void* user_context, p_dma_context pdma_context, uintptr_t frame);

/**
 *  halide_hexagon_dmart_clr_host_frame
 * clear frame
 * frame = VA of frame buffer  */
extern int halide_hexagon_dmart_clr_host_frame(void* user_context, p_dma_context pdma_context, uintptr_t frame);
...
extern int halide_hexagon_dmart_set_storage_linkage(void* user_context, p_dma_context pdma_context, uintptr_t frame, uintptr_t fold, int store_id);
...
extern int halide_hexagon_dmart_create_context(void* user_context, p_dma_context* pdma_context, int nFrames);
...
extern int halide_hexagon_dmart_delete_context(void* user_context, p_dma_context pdma_context);
...
extern int halide_hexagon_dmart_attach_context(void* user_context, p_dma_context pdma_context, uintptr_t frame, int type,
...
extern int halide_hexagon_dmart_detach_context(void* user_context, p_dma_context pdma_context, uintptr_t frame);
 ...
 * frame = VA of frame buffer
 * plane = Y/UV  */
extern int halide_hexagon_dmart_set_component(void* user_context, p_dma_context pdma_context, uintptr_t frame, int plane);
...
extern int halide_hexagon_dmart_set_padding(void* user_context, p_dma_context pdma_context, uintptr_t frame, int flag);
...
extern int halide_hexagon_dmart_set_parallel(void* user_context, p_dma_context pdma_context, int threads);
...
extern int halide_hexagon_dmart_set_max_fold_storage(void* user_context, p_dma_context pdma_context, uintptr_t frame,
 ...
 * This may not be needed  */
extern int halide_hexagon_dmart_set_resource(void* user_context, p_dma_context pdma_context, int lock, int* rsc_id);
...
extern int halide_hexagon_dmart_set_device_storage_offset(void* user_context, p_dma_context pdma_context, uintptr_t dev_buf,
...
extern int halide_hexagon_dmart_set_host_roi(void* user_context, p_dma_context pdma_context, uintptr_t dev_buf, int x, int y,
...
extern int halide_hexagon_dmart_get_update(void* user_context, p_dma_context pdma_context, uintptr_t frame, bool &update);

/**
 * halide_hexagon_dmart_set_update
 * start update  */
extern int halide_hexagon_dmart_set_update(void* user_context, p_dma_context pdma_context, uintptr_t frame);
