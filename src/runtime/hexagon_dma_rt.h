 ...
 * in: addr_t frame
 * out: bool read_flag */
extern int halide_hexagon_dmart_is_buffer_read(void* user_context, uintptr_t frame, bool* is_read);

/**
 * halide_hexagon_dmart_get_fold_size
 * in: addr_t frame
 * out: unsigned int size */
extern int halide_hexagon_dmart_get_fold_size(void* user_context, uintptr_t frame);
 ...
 * in: addr_t frame
 * out: frameIDx */
extern int halide_hexagon_dmart_get_frame_index(void* user_context, uintptr_t frame);
...
extern int halide_hexagon_dmart_get_num_components (void* user_context, uintptr_t frame);
...
extern int halide_hexagon_dmart_set_storage_linkage(void* user_context, uintptr_t frame, uintptr_t fold, int store_id);
