...
define weak_odr <16 x i8> @saturating_narrow_u16x16_to_u8x16(<16 x i16> %x) nounwind alwaysinline {
  %1 = insertelement <8 x i16> undef, i16 32767, i32 0
  %2 = shufflevector <8 x i16> %1, <8 x i16> undef, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0>
  %3 = shufflevector <16 x i16> %x, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = shufflevector <16 x i16> %x, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %5 = and <8 x i16> %3, %2
  %6 = and <8 x i16> %4, %2
  %7 = tail call <16 x i8> @llvm.wasm.narrow.unsigned.v16i8.v8i16(<8 x i16> %5, <8 x i16> %6)
  ret <16 x i8> %7
}

define weak_odr <8 x i16> @saturating_narrow_u32x8_to_u16x8(<8 x i32> %x) nounwind alwaysinline {
  %1 = insertelement <4 x i32> undef, i32 2147483647, i32 0
  %2 = shufflevector <4 x i32> %1, <4 x i32> undef, <4 x i32> <i32 0, i32 0, i32 0, i32 0>
  %3 = shufflevector <8 x i32> %x, <8 x i32> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %4 = shufflevector <8 x i32> %x, <8 x i32> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %5 = and <4 x i32> %3, %2
  %6 = and <4 x i32> %4, %2
  %7 = tail call <8 x i16> @llvm.wasm.narrow.unsigned.v8i16.v4i32(<4 x i32> %5, <4 x i32> %6)
  ret <8 x i16> %7
}
