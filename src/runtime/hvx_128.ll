...
define weak_odr <128 x i8> @halide.hexagon.trunc_satub_shr.vw.w(<128 x i32> %arg0, i32 %arg1) nounwind uwtable readnone alwaysinline {
  ...
  %hilo = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %hi, <32 x i32> %lo)
  %vp_half = bitcast <64 x i32> %hilo to <128 x i16>
  %vp_half_deint = call <128 x i16> @halide.hexagon.deinterleave.vh(<128 x i16> %vp_half)
  %vp = bitcast <128 x i16> %vp_half_deint to <64 x i32>
  %e = call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %vp)
  %o = call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %vp)
