...
int halide_hexagon_dmart_get_frame_index(void* user_context, uintptr_t frame) {
    int index,i;
...
int halide_hexagon_dmaapp_dma_init(void *user_context, void *dma_context, int nframes) {
    int i;
...
int halide_hexagon_dmart_is_buffer_read(void* user_context, uintptr_t frame, bool *is_read) {
    t_dma_context *pdma_context;
    halide_hexagon_get_dma_context(user_context, &pdma_context);
    halide_assert(user_context, pdma_context != NULL);
 ...
 * Get Fold Size */
int halide_hexagon_dmart_get_fold_size(void* user_context, uintptr_t frame) {
    t_dma_context *pdma_context;
    halide_hexagon_get_dma_context(user_context, &pdma_context);
    halide_assert(user_context, pdma_context != NULL);
...
int halide_hexagon_dmart_get_num_components (void* user_context, uintptr_t frame) {
    int index;
    int i;
    t_dma_context *pdma_context;
    halide_hexagon_get_dma_context(user_context, &pdma_context);
...
int  halide_hexagon_dmart_get_tcm_desc_params(void* user_context, uintptr_t dev_buf, uintptr_t *tcm_region, qurt_size_t *size_tcm, \
