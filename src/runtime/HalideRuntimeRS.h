#ifndef HALIDE_HALIDERUNTIMERS_H
#define HALIDE_HALIDERUNTIMERS_H
...
/** \file
 *  Routines specific to the Halide RS runtime.
 */

extern const struct halide_device_interface *halide_rs_device_interface();

/** These are forward declared here to allow clients to override the
 *  Halide RS runtime. Do not call them. */
// @{
extern int halide_rs_initialize_kernels(void *user_context, void **state_ptr,
                                        const char *src, int size);
extern int halide_rs_run(void *user_context, void *state_ptr,
...
// extern void halide_rs_set_platform_name(const char *n);
...
// extern const char *halide_rs_get_platform_name(void *user_context);
...
// extern void halide_rs_set_device_type(const char *n);
...
// extern const char *halide_rs_get_device_type(void *user_context);
...
extern int halide_rs_wrap_cl_mem(void *user_context, struct buffer_t *buf,
                                 uintptr_t device_ptr);

/** Disconnect a buffer_t from the memory it was previously wrapped
 * around. Should only be called for a buffer_t that
 * halide_rs_wrap_device_ptr was previously called on. Frees any
 ...
 * return.
 */
extern uintptr_t halide_rs_detach_cl_mem(void *user_context,
                                         struct buffer_t *buf);
 ...
 *  returns 0.
 */
extern uintptr_t halide_rs_get_cl_mem(void *user_context, struct buffer_t *buf);

#ifdef __cplusplus
}  // End extern "C"
#endif

#endif  // HALIDE_HALIDERUNTIMERS_H
