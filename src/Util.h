...
/** Load a plugin (e.g. for custom autoschedulers). If the string doesn't contain
 * any . characters, the proper prefix and/or suffix for the platform will be added;
