...
class AutoScheduleGen : public Halide::Generator<AutoScheduleGen> {
public:
    ...
    void schedule() {
        ...
        // To use the auto-scheduler, we need to provide estimates on the
        // input/output sizes including estimates on the parameter values.
        ...
        // for generic CPU architecture are going to be used by the auto-scheduler.

        // Let's use some random values for the machine parameters.
        ...
        // a string representation of the schedule. This pipeline, for example,
        // will return the following schedule for the estimates and machine
        ...
        // This string representation of the generated schedule is readily
        // copy-pastable back into this generator schedule with little
        // modifications. Programmers can use this as a starting schedule
        // and iteratively improve the schedule. Note that, the current
        // auto-scheduler is only able to generate CPU schedule and only does
        // tiling, simple vectorization and parallelization. It doesn't deal
        // with line buffering, storage reordering, or factoring a reduction.
    }
private:
    Var x{"x"}, y{"y"}, z{"z"}, n{"n"};
    Func f;
...
HALIDE_REGISTER_GENERATOR(AutoScheduleGen, auto_schedule_gen)
