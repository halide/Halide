...
// g++ lesson_03*.cpp -g -I <path/to/include> -L <path/to/lib> -lHalide -lpthread -ldl -o lesson_03 -std=c++17
// LD_LIBRARY_PATH=<path/to/lib> ./lesson_03

// On macOS:
// g++ lesson_03*.cpp -g -I <path/to/include> -L <path/to/lib> -lHalide -o lesson_03 -std=c++17
// DYLD_LIBRARY_PATH=<path/to/lib> ./lesson_03
