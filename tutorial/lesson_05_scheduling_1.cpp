...
// g++ lesson_05*.cpp -g -I <path/to/include> -L <path/to/lib> -lHalide -lpthread -ldl -o lesson_05 -std=c++17
// LD_LIBRARY_PATH=<path/to/lib> ./lesson_05

// On macOS:
// g++ lesson_05*.cpp -g -I <path/to/include> -L <path/to/lib> -lHalide -o lesson_05 -std=c++17
// DYLD_LIBRARY_PATH=<path/to/lib> ./lesson_05
