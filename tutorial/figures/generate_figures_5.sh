...
# tiles
cat tmp/trace.bin | ../../bin/HalideTraceViz -s 320 320 -t 1 -d 10000 -h 10 -f gradient_tiled 0 14 -1 0 32 1 32 32 1 0 0 1 | avconv -f rawvideo -pix_fmt bgr32 -s 320x320 -i /dev/stdin tmp/frames_%04d.tif
...
cat tmp/trace.bin |  ../../bin/HalideTraceViz -s 700 500 -t 1000 -d 2 -h 30 -f gradient_fast 0 600 -1 0 2 1 1 1 1 0 0 1 | avconv -f rawvideo -pix_fmt bgr32 -s 700x500 -i /dev/stdin -c:v h264 lesson_05_fast.mp4
